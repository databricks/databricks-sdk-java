...
public class EnvTest implements Extension, ParameterResolver, ExecutionCondition {
    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
        ...
        Optional<List<Parameter>> methodParams = context.getElement()
    ...
    private Optional<EnvGetter> makeEnvResolver(ExtensionContext context) {
        ...
        return context.getElement()
                ...
                .map(contextName -> store.getOrComputeIfAbsent(ENV_STORE_KEY,
                        x -> makeEnvResolver(contextName), EnvGetter.class));
    }

    private EnvGetter makeEnvResolver(String contextName) {
        String debugEnvFile = String.format("%s/.databricks/debug-env.json", System.getProperty("user.home"));
