...
public class SerDeUtilsTest {
  ...
  public void testEmptyClassRoundTrip() throws JsonProcessingException {
    OnlineTableSpecContinuousSchedulingPolicy policy =
        new OnlineTableSpecContinuousSchedulingPolicy();
    ObjectMapper mapper = SerDeUtils.createMapper();
    String json = mapper.writeValueAsString(policy);
    assert json.equals("{}");
    OnlineTableSpecContinuousSchedulingPolicy result =
        mapper.readValue(json, OnlineTableSpecContinuousSchedulingPolicy.class);
