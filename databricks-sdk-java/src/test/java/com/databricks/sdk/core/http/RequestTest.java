...
class RequestTest {
  ...
  static Stream<Arguments> getUriCases() {
    return Stream.of(
        Arguments.of("just path", new Request("GET", "/foo"), "/foo"),
        Arguments.of(
            "with query param",
        ...
        Arguments.of(
            ...
            new Request("GET", "/foo").withQueryParam("foo", "bar").withQueryParam("foo", "baz"),
            "/foo?foo=bar&foo=baz"),
        Arguments.of(
            ...
            new Request(
                "GET",
                String.format(
                    "/api/2.1/tables/%s", Encoding.encodeMultiSegmentPathParameter("name|here"))),
  ...
  static Stream<Arguments> getRequestLineCases() {
    return Stream.of(
        Arguments.of("simple path", new Request("GET", "/foo"), "GET /foo"),
        Arguments.of(
