...
public class DatabricksAuthTest implements ConfigResolving {
  ...
  public void testTestConfigHostParamTokenEnv() {
    // Set environment variables
    StaticEnv env = new StaticEnv().with("DATABRICKS_TOKEN", "x");
    DatabricksConfig config = getNewConfig().setHost("https://x");
  ...
  public void testTestConfigAttributePrecedence() {
    ...
    StaticEnv env =
        new StaticEnv()
            ...
            .with("DATABRICKS_PASSWORD", "x")
            .with("DATABRICKS_USERNAME", "x");
    DatabricksConfig config = getNewConfig().setHost("y");
  ...
  public void testTestConfigBasicAuthMix() {
    ...
    DatabricksConfig config = getNewConfig().setHost("y").setUsername("x");
  ...
  public void testTestConfigBasicAuthAttrs() {
    ...
    DatabricksConfig config = getNewConfig().setHost("y").setUsername("x").setPassword("x");
  ...
  public void testTestConfigConflictingEnvsAuthType() {
    ...
    StaticEnv env =
        new StaticEnv()
            ...
            .with("DATABRICKS_TOKEN", "x")
            .with("DATABRICKS_USERNAME", "x");
    DatabricksConfig config = getNewConfig().setAuthType("basic");
  ...
  public void testTestConfigConfigFileSkipDefaultProfileIfHostSpecified() {
    ...
    raises(
        ...
        () -> {
          DatabricksConfig config = getNewConfig().setHost("x");
  ...
  public void testTestConfigAzurePat() {
    ...
    DatabricksConfig config =
        getNewConfig().setHost("https://adb-xxx.y.azuredatabricks.net/").setToken("y");
  ...
  public void testTestConfigAzureCliHost() {
    ...
    DatabricksConfig config = getNewConfig().setHost("x").setAzureWorkspaceResourceId("/sub/rg/ws");
  ...
  public void testTestConfigAzureCliHostFail() {
    ...
    raises(
        ...
        () -> {
          DatabricksConfig config = getNewConfig().setAzureWorkspaceResourceId("/sub/rg/ws");
  ...
  public void testTestConfigAzureCliHostPatConflictWithConfigFilePresentWithoutDefaultProfile() {
    ...
    raises(
        ...
        () -> {
          DatabricksConfig config =
              getNewConfig().setToken("x").setAzureWorkspaceResourceId("/sub/rg/ws");
  ...
  public void testTestConfigAzureAndPasswordConflict() {
    ...
    raises(
        ...
        () -> {
          DatabricksConfig config =
              getNewConfig().setHost("x").setAzureWorkspaceResourceId("/sub/rg/ws");
