...
public class DatabricksAuthTest {
    ...
    public void testTestConfigHostEnv() {
        ...
        StaticEnv env = new StaticEnv()
          .with("DATABRICKS_HOST", "x");raises("default auth: cannot configure default credentials. Config: host=https://x. Env: DATABRICKS_HOST", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigTokenEnv() {
        // Set environment variables
        StaticEnv env = new StaticEnv()
          .with("DATABRICKS_TOKEN", "x");raises("default auth: cannot configure default credentials. Config: token=***. Env: DATABRICKS_TOKEN", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigUserPasswordEnv() {
        ...
        StaticEnv env = new StaticEnv()
          ...
          .with("DATABRICKS_USERNAME", "x");raises("default auth: cannot configure default credentials. Config: username=x, password=***. Env: DATABRICKS_USERNAME, DATABRICKS_PASSWORD", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigConflictingEnvs() {
        ...
        StaticEnv env = new StaticEnv()
          ...
          .with("DATABRICKS_PASSWORD", "x")
          .with("DATABRICKS_TOKEN", "x")
          .with("DATABRICKS_USERNAME", "x");raises("validate: more than one authorization method configured: basic and pat. Config: host=x, token=***, username=x, password=***. Env: DATABRICKS_HOST, DATABRICKS_TOKEN, DATABRICKS_USERNAME, DATABRICKS_PASSWORD", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigConfigFile() {
        // Set environment variables
        StaticEnv env = new StaticEnv()
          .with("DATABRICKS_CONFIG_FILE", "x");raises("default auth: cannot configure default credentials. Config: config_file=x. Env: DATABRICKS_CONFIG_FILE", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigConfigFileSkipDefaultProfileIfHostSpecified() {
        // Set environment variables
        StaticEnv env = new StaticEnv()
          .with("HOME", resource("/testdata"));raises("default auth: cannot configure default credentials. Config: host=https://x", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .setHost("x")
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigPatFromDatabricksCfgNohostProfile() {
        ...
        StaticEnv env = new StaticEnv()
          ...
          .with("HOME", resource("/testdata"));raises("default auth: cannot configure default credentials. Config: token=***, profile=nohost. Env: DATABRICKS_CONFIG_PROFILE", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigConfigProfileAndToken() {
        ...
        StaticEnv env = new StaticEnv()
          .with("DATABRICKS_CONFIG_PROFILE", "nohost")
          .with("DATABRICKS_TOKEN", "x")
          .with("HOME", resource("/testdata"));raises("default auth: cannot configure default credentials. Config: token=***, profile=nohost. Env: DATABRICKS_TOKEN, DATABRICKS_CONFIG_PROFILE", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigConfigProfileAndPassword() {
        ...
        StaticEnv env = new StaticEnv()
          .with("DATABRICKS_CONFIG_PROFILE", "nohost")
          .with("DATABRICKS_USERNAME", "x")
          .with("HOME", resource("/testdata"));raises("validate: more than one authorization method configured: basic and pat. Config: token=***, username=x, profile=nohost. Env: DATABRICKS_USERNAME, DATABRICKS_CONFIG_PROFILE", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigAzureCliHostFail() {
        ...
        StaticEnv env = new StaticEnv()
          .with("FAIL", "yes")
          .with("HOME", resource("/testdata/azure"))
          .with("PATH", "testdata:/bin");raises("default auth: azure-cli: cannot get access token: This is just a failing script.\n. Config: azure_workspace_resource_id=/sub/rg/ws", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .setAzureWorkspaceResourceId("/sub/rg/ws")
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigAzureCliHostAzNotInstalled() {
        ...
        StaticEnv env = new StaticEnv()
          .with("HOME", resource("/testdata/azure"))
          .with("PATH", "whatever");raises("default auth: cannot configure default credentials. Config: azure_workspace_resource_id=/sub/rg/ws", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .setAzureWorkspaceResourceId("/sub/rg/ws")
              .resolve(env);
            config.authenticate();
    ...
    public void testTestConfigAzureCliHostPatConflictWithConfigFilePresentWithoutDefaultProfile() {
        ...
        StaticEnv env = new StaticEnv()
          .with("HOME", resource("/testdata/azure"))
          .with("PATH", "testdata:/bin");raises("validate: more than one authorization method configured: azure and pat. Config: token=***, azure_workspace_resource_id=/sub/rg/ws", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .setToken("x")
              .setAzureWorkspaceResourceId("/sub/rg/ws")
              .resolve(env);
    ...
    public void testTestConfigAzureAndPasswordConflict() {
        ...
        StaticEnv env = new StaticEnv()
          .with("DATABRICKS_USERNAME", "x")
          .with("HOME", resource("/testdata/azure"))
          .with("PATH", "testdata:/bin");raises("validate: more than one authorization method configured: azure and basic. Config: host=x, username=x, azure_workspace_resource_id=/sub/rg/ws. Env: DATABRICKS_USERNAME", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .setHost("x")
              .setAzureWorkspaceResourceId("/sub/rg/ws")
              .resolve(env);
    ...
    public void testTestConfigCorruptConfig() {
        ...
        StaticEnv env = new StaticEnv()
          ...
          .with("HOME", resource("/testdata/corrupt"));raises("resolve: testdata/corrupt/.databrickscfg has no DEFAULT profile configured. Config: profile=DEFAULT. Env: DATABRICKS_CONFIG_PROFILE", () -> { 
            DatabricksConfig config = new DatabricksConfig()
              .resolve(env);
            config.authenticate();
