...
class TestNestedMessageTest {
    ...
    void testMarshallMessageSerializationEquality() throws Exception {
        ...
        List<com.databricks.sdk.testmarshall.before.TestEnum> repeatedEnumsBefore = Arrays.asList(
        ...
        List<com.databricks.sdk.testmarshall.after.TestEnum> repeatedEnumsAfter = Arrays.asList(
        ...
        com.databricks.sdk.testmarshall.before.TestNestedMessage beforeNested = new com.databricks.sdk.testmarshall.before.TestNestedMessage()
                .setMap(map)
                .setNestedBool(true)
        ...
        com.databricks.sdk.testmarshall.after.TestNestedMessage afterNested = new com.databricks.sdk.testmarshall.after.TestNestedMessage()
                .setMap(map)
                .setNestedBool(true)
        ...
        List<com.databricks.sdk.testmarshall.before.TestNestedMessage> repeatedNestedBefore = Arrays.asList(beforeNested);
        List<com.databricks.sdk.testmarshall.after.TestNestedMessage> repeatedNestedAfter = Arrays.asList(afterNested);

        // Create main messages
        com.databricks.sdk.testmarshall.before.TestMarshallMessage beforeMsg = new com.databricks.sdk.testmarshall.before.TestMarshallMessage()
                .setMap(map)
        ...
        com.databricks.sdk.testmarshall.after.TestMarshallMessage afterMsg = new com.databricks.sdk.testmarshall.after.TestMarshallMessage()
                .setMap(map)
