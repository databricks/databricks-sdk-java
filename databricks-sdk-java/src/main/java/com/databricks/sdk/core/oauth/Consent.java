...
public class Consent implements Serializable {
   ...
   */
  public CachedTokenSource launchExternalBrowser() throws IOException {
  ...
  public CachedTokenSource exchangeCallbackParameters(Map<String, String> query) {
  ...
  public CachedTokenSource exchange(String code, String state) {
