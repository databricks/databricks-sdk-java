 ...
 * 
 * <p>Clients could ignore the recommendation here or retry when this information
 * is missing from error responses. However, it's always recommended that clients
 * should use exponential backoff when retrying.
 * 
 * <p>Clients should wait until the {@code retryDelay} amount of time has passed
 * since receiving the error response before retrying. If retrying requests also
 * fail, clients should use an exponential backoff scheme to gradually increase
 * the delay between retries based on {@code retryDelay}, until either a maximum
 * number of retries have been reached or a maximum retry delay cap has been reached.
 * 
 * <p>This information helps clients implement intelligent retry strategies that
 * respect the service's recommendations while avoiding overwhelming the service
...
public abstract class RetryInfo {
     ...
     * 
     * <p>Note: This is serialized as a string in the format "3.000000001s" where
     * the string ends in the suffix "s" (indicating seconds) and is preceded by
     * a decimal number of seconds.
     * 
     * <p>Examples of valid formats:
     * <ul>
     *   <li>"30s" - 30 seconds</li>
     *   <li>"1.5s" - 1.5 seconds</li>
     *   <li>"0.001s" - 1 millisecond</li>
     *   <li>"3.000000001s" - 3 seconds and 1 nanosecond</li>
     * </ul>
     * 
     ...
     * 
     * <p>This deserializer is strict and will reject invalid duration formats
     * by throwing an IOException. Valid formats must:
     * <ul>
     *   <li>Be a string value</li>
     *   <li>End with the 's' suffix</li>
     *   <li>Contain a valid decimal number before the suffix</li>
     * </ul>
     * 
     * <p>Examples of valid formats: "30s", "1.5s", "0.001s", "3.000000001s"
     * Examples of invalid formats: "30", "30ms", "abc", 42
     */
