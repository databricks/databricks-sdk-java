                ...
                try {
                    switch (type) {
                        ...
                        case PRECONDITION_FAILURE_TYPE:
                            PreconditionFailure preconditionFailure = mapper.treeToValue(objectNode, PreconditionFailure.class);
        ...
        try {
            switch (type) {
                ...
                case PRECONDITION_FAILURE_TYPE:
                    PreconditionFailure preconditionFailure = mapper.treeToValue(objectNode, PreconditionFailure.class);
                    return ErrorDetails.builder()
                        .setPreconditionFailure(preconditionFailure)
                        .build();
                case BAD_REQUEST_TYPE:
                    BadRequest badRequest = mapper.treeToValue(objectNode, BadRequest.class);
                    return ErrorDetails.builder()
                ...
                default:
                    ...
                    return ErrorDetails.builder()
                        .setUnknownDetails(unknownDetails)
                        .build();
            }
        } catch (Exception e) {
