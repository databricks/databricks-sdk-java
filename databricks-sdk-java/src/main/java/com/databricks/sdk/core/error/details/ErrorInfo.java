 ...
 * <ul>
 *   <li>The reason for the error (a constant value identifying the proximate cause)</li>
 *   <li>The logical grouping to which the "reason" belongs</li>
 *   <li>Additional structured details about the error</li>
 * </ul>
 * 
 ...
 *   <li>Implement appropriate error handling logic</li>
...
public abstract class ErrorInfo {
     ...
     * 
     * <p>Examples might include: "INVALID_ARGUMENT", "RESOURCE_NOT_FOUND",
     ...
     * 
     * <p>This provides context about the domain or category of the error.
     * Examples might include: "databricks.api", "databricks.auth", etc.
     * 
     ...
     * 
     * <p>This map can contain arbitrary key-value pairs that provide
     * additional context about the error. The exact contents depend on
     * the specific error type and the service implementation.
     * 
