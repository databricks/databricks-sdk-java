...
public class RegisteredModelAccessControlResponse {
  ...
  public RegisteredModelAccessControlResponse setDisplayName(String displayName) {
  ...
  public RegisteredModelAccessControlResponse setGroupName(String groupName) {
  ...
  public RegisteredModelAccessControlResponse setServicePrincipalName(String servicePrincipalName) {
  ...
  public RegisteredModelAccessControlResponse setUserName(String userName) {
  ...
  public boolean equals(Object o) {
    ...
    RegisteredModelAccessControlResponse that = (RegisteredModelAccessControlResponse) o;
  ...
  public String toString() {
    return new ToStringer(RegisteredModelAccessControlResponse.class)
