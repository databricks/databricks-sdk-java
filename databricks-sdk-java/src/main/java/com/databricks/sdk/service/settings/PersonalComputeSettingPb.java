...
@Generated
class PersonalComputeSettingPb {
  @JsonProperty("etag")
  private String etag;
  ...
  public PersonalComputeSettingPb setEtag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public PersonalComputeSettingPb setPersonalCompute(PersonalComputeMessage personalCompute) {
  ...
  public PersonalComputeSettingPb setSettingName(String settingName) {
  ...
  public boolean equals(Object o) {
    ...
    PersonalComputeSettingPb that = (PersonalComputeSettingPb) o;
  ...
  public String toString() {
    return new ToStringer(PersonalComputeSettingPb.class)
        .add("etag", etag)
