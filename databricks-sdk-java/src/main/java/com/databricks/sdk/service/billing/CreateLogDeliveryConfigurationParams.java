...
public class CreateLogDeliveryConfigurationParams {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configName, credentialsId, deliveryPathPrefix, deliveryStartTime, logType, outputFormat, status, storageConfigurationId, workspaceIdsFilter);
  }
