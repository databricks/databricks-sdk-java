...
class UpdateClusterResourcePb {
  ...
  public UpdateClusterResourcePb setAutoscale(AutoScale autoscale) {
  ...
  public UpdateClusterResourcePb setAutoterminationMinutes(Long autoterminationMinutes) {
  ...
  public UpdateClusterResourcePb setAwsAttributes(AwsAttributes awsAttributes) {
  ...
  public UpdateClusterResourcePb setAzureAttributes(AzureAttributes azureAttributes) {
  ...
  public UpdateClusterResourcePb setClusterLogConf(ClusterLogConf clusterLogConf) {
  ...
  public UpdateClusterResourcePb setClusterName(String clusterName) {
  ...
  public UpdateClusterResourcePb setCustomTags(Map<String, String> customTags) {
  ...
  public UpdateClusterResourcePb setDataSecurityMode(DataSecurityMode dataSecurityMode) {
  ...
  public UpdateClusterResourcePb setDockerImage(DockerImage dockerImage) {
  ...
  public UpdateClusterResourcePb setDriverInstancePoolId(String driverInstancePoolId) {
  ...
  public UpdateClusterResourcePb setDriverNodeTypeId(String driverNodeTypeId) {
  ...
  public UpdateClusterResourcePb setEnableElasticDisk(Boolean enableElasticDisk) {
  ...
  public UpdateClusterResourcePb setEnableLocalDiskEncryption(Boolean enableLocalDiskEncryption) {
  ...
  public UpdateClusterResourcePb setGcpAttributes(GcpAttributes gcpAttributes) {
  ...
  public UpdateClusterResourcePb setInitScripts(Collection<InitScriptInfo> initScripts) {
  ...
  public UpdateClusterResourcePb setInstancePoolId(String instancePoolId) {
  ...
  public UpdateClusterResourcePb setIsSingleNode(Boolean isSingleNode) {
  ...
  public UpdateClusterResourcePb setKind(Kind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public UpdateClusterResourcePb setNodeTypeId(String nodeTypeId) {
  ...
  public UpdateClusterResourcePb setNumWorkers(Long numWorkers) {
  ...
  public UpdateClusterResourcePb setPolicyId(String policyId) {
  ...
  public UpdateClusterResourcePb setRemoteDiskThroughput(Long remoteDiskThroughput) {
  ...
  public UpdateClusterResourcePb setRuntimeEngine(RuntimeEngine runtimeEngine) {
  ...
  public UpdateClusterResourcePb setSingleUserName(String singleUserName) {
  ...
  public UpdateClusterResourcePb setSparkConf(Map<String, String> sparkConf) {
  ...
  public UpdateClusterResourcePb setSparkEnvVars(Map<String, String> sparkEnvVars) {
  ...
  public UpdateClusterResourcePb setSparkVersion(String sparkVersion) {
  ...
  public UpdateClusterResourcePb setSshPublicKeys(Collection<String> sshPublicKeys) {
  ...
  public UpdateClusterResourcePb setTotalInitialRemoteDiskSize(Long totalInitialRemoteDiskSize) {
  ...
  public UpdateClusterResourcePb setUseMlRuntime(Boolean useMlRuntime) {
  ...
  public UpdateClusterResourcePb setWorkloadType(WorkloadType workloadType) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateClusterResourcePb that = (UpdateClusterResourcePb) o;
  ...
  public String toString() {
    return new ToStringer(UpdateClusterResourcePb.class)
