...
class PermissionPb {
  ...
  public PermissionPb setInherited(Boolean inherited) {
  ...
  public PermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public PermissionPb setPermissionLevel(PermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    PermissionPb that = (PermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(PermissionPb.class)
