...
@Generated
@JsonSerialize(using = Permission.PermissionSerializer.class)
@JsonDeserialize(using = Permission.PermissionDeserializer.class)
public class Permission {
  ...
  static Permission fromPb(PermissionPb pb) {
  ...
  public static class PermissionSerializer extends JsonSerializer<Permission> {
    @Override
    public void serialize(Permission value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      PermissionPb pb = value.toPb();
  ...
  public static class PermissionDeserializer extends JsonDeserializer<Permission> {
    ...
    public Permission deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      PermissionPb pb = mapper.readValue(p, PermissionPb.class);
      return Permission.fromPb(pb);
    }
  }
}
