 ...
 */
@Generated
public class ResolveServicePrincipalRequest {
  /** Required. The external ID of the service principal in the customer's IdP. */
  @JsonProperty("external_id")
  private String externalId;

  public ResolveServicePrincipalRequest setExternalId(String externalId) {
  ...
  public boolean equals(Object o) {
    ...
    ResolveServicePrincipalRequest that = (ResolveServicePrincipalRequest) o;
  ...
  public String toString() {
    return new ToStringer(ResolveServicePrincipalRequest.class)
