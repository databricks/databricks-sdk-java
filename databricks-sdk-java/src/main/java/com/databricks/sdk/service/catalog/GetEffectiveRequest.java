...
public class GetEffectiveRequest {
   ...
   * principal.
   *
   * <p>If not set, all the effective permissions are returned. If set to
   *
   * <ul>
   ...
   *       server is able to return at least one complete EffectivePrivilegeAssignment in a single
   *       page response)
