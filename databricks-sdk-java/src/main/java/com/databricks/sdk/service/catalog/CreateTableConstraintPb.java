...
class CreateTableConstraintPb {
  ...
  public CreateTableConstraintPb setConstraint(TableConstraint constraint) {
  ...
  public CreateTableConstraintPb setFullNameArg(String fullNameArg) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTableConstraintPb that = (CreateTableConstraintPb) o;
  ...
  public String toString() {
    return new ToStringer(CreateTableConstraintPb.class)
