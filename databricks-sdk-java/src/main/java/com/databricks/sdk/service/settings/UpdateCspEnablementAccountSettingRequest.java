...
@JsonSerialize(
    using =
        UpdateCspEnablementAccountSettingRequest.UpdateCspEnablementAccountSettingRequestSerializer
            .class)
@JsonDeserialize(
    using =
        UpdateCspEnablementAccountSettingRequest
            .UpdateCspEnablementAccountSettingRequestDeserializer.class)
public class UpdateCspEnablementAccountSettingRequest {
  ...
  UpdateCspEnablementAccountSettingRequestPb toPb() {
    UpdateCspEnablementAccountSettingRequestPb pb =
        new UpdateCspEnablementAccountSettingRequestPb();
  ...
  static UpdateCspEnablementAccountSettingRequest fromPb(
      UpdateCspEnablementAccountSettingRequestPb pb) {
    UpdateCspEnablementAccountSettingRequest model = new UpdateCspEnablementAccountSettingRequest();
  ...
  public static class UpdateCspEnablementAccountSettingRequestSerializer
      extends JsonSerializer<UpdateCspEnablementAccountSettingRequest> {
    @Override
    public void serialize(
        UpdateCspEnablementAccountSettingRequest value,
        JsonGenerator gen,
        SerializerProvider provider)
        throws IOException {
      UpdateCspEnablementAccountSettingRequestPb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class UpdateCspEnablementAccountSettingRequestDeserializer
      extends JsonDeserializer<UpdateCspEnablementAccountSettingRequest> {
    @Override
    public UpdateCspEnablementAccountSettingRequest deserialize(
        JsonParser p, DeserializationContext ctxt) throws IOException {
      // The Codec is set by us in the SerDeUtils.java, and it is an ObjectMapper.
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      UpdateCspEnablementAccountSettingRequestPb pb =
          mapper.readValue(p, UpdateCspEnablementAccountSettingRequestPb.class);
      return UpdateCspEnablementAccountSettingRequest.fromPb(pb);
    }
  }
}
