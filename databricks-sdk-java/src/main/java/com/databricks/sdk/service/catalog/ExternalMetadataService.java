...
public interface ExternalMetadataService {
   ...
   * admin or has the <b>CREATE_EXTERNAL_METADATA</b> privilege. Grants <b>BROWSE</b> to all account
   ...
   * admin, the owner of the external metadata object, or a user that has the <b>BROWSE</b>
   * privilege.
   */
   ...
   * objects that the caller has <b>BROWSE</b> on will be retrieved. There is no guarantee of a
   ...
   * the owner of the external metadata object, or a user that has the <b>MODIFY</b> privilege. If
   * the caller is updating the owner, they must also have the <b>MANAGE</b> privilege.
   */
