...
@Generated
@JsonSerialize(using = JobEmailNotifications.JobEmailNotificationsSerializer.class)
@JsonDeserialize(using = JobEmailNotifications.JobEmailNotificationsDeserializer.class)
public class JobEmailNotifications {
  ...
  JobEmailNotificationsPb toPb() {
    JobEmailNotificationsPb pb = new JobEmailNotificationsPb();
  ...
  static JobEmailNotifications fromPb(JobEmailNotificationsPb pb) {
    JobEmailNotifications model = new JobEmailNotifications();
  ...
  public static class JobEmailNotificationsSerializer
      extends JsonSerializer<JobEmailNotifications> {
    @Override
    public void serialize(
        JobEmailNotifications value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      JobEmailNotificationsPb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class JobEmailNotificationsDeserializer
      extends JsonDeserializer<JobEmailNotifications> {
    @Override
