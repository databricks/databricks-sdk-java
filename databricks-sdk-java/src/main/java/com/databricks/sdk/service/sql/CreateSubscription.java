...
public class CreateSubscription {
  ...
  /**
   * ID of the alert subscriber (if subscribing an alert destination). Alert destinations can be
   * configured by admins through the UI. See [here](/sql/admin/alert-destinations.html).
   */
