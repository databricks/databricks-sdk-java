...
public class DashboardsAPI {
  ...
  public void delete(String dashboardId) {
    delete(new DeleteDashboardRequest()
  ...
  public Dashboard get(String dashboardId) {
    return get(new GetDashboardRequest()
      .setDashboardId(dashboardId));
  }
  ...
  public Iterable<Dashboard> list(ListDashboardsRequest request) {
    request.setPage(1L);return new Paginator<>(request, impl::list, ListResponse::getResults, response -> {
  ...
  public void restore(String dashboardId) {
    restore(new RestoreDashboardRequest()
      .setDashboardId(dashboardId));
  }
