...
public class Dashboard {
  ...
  /**
   * Indicates whether this query object appears in the current user's favorites
   * list. This flag determines whether the star icon for favorites is selected.
   */
  @JsonProperty("is_favorite")
  private Boolean isFavorite;
  
  /**
   * The title of the dashboard that appears in list views and at the top of the
   * dashboard page.
   */
  @JsonProperty("name")
  private String name;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(canEdit, createdAt, dashboardFiltersEnabled, id, isArchived, isDraft, isFavorite, name, options, parent, permissionTier, slug, tags, updatedAt, user, userId, widgets);
  }
