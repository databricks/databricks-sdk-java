...
public interface ModelVersionsService {
  ...
  /**
   * List the model versions of the specified registered model, identified by its full three-level
   ...
   * owner or have the **EXECUTE** privilege on the parent registered model to receive the model
