...
public class UpdateWidgetRequest {
  ...
  public UpdateWidgetRequest setDashboardId(String dashboardId) {
  ...
  public UpdateWidgetRequest setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateWidgetRequest setOptions(WidgetOptions options) {
  ...
  public UpdateWidgetRequest setText(String text) {
    this.text = text;
    return this;
  }
  ...
  public UpdateWidgetRequest setVisualizationId(String visualizationId) {
  ...
  public UpdateWidgetRequest setWidth(Long width) {
    this.width = width;
    return this;
  }
  ...
  public String toString() {
    return new ToStringer(UpdateWidgetRequest.class)
