...
@Generated
class CreateModelResponsePb {
  @JsonProperty("registered_model")
  private Model registeredModel;

  public CreateModelResponsePb setRegisteredModel(Model registeredModel) {
  ...
  public boolean equals(Object o) {
    ...
    CreateModelResponsePb that = (CreateModelResponsePb) o;
  ...
  public String toString() {
    return new ToStringer(CreateModelResponsePb.class)
