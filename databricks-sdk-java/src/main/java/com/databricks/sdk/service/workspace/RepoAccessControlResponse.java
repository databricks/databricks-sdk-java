...
@Generated
@JsonSerialize(using = RepoAccessControlResponse.RepoAccessControlResponseSerializer.class)
@JsonDeserialize(using = RepoAccessControlResponse.RepoAccessControlResponseDeserializer.class)
public class RepoAccessControlResponse {
  ...
  RepoAccessControlResponsePb toPb() {
    RepoAccessControlResponsePb pb = new RepoAccessControlResponsePb();
  ...
  static RepoAccessControlResponse fromPb(RepoAccessControlResponsePb pb) {
    RepoAccessControlResponse model = new RepoAccessControlResponse();
  ...
  public static class RepoAccessControlResponseSerializer
      extends JsonSerializer<RepoAccessControlResponse> {
    @Override
    public void serialize(
        RepoAccessControlResponse value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      RepoAccessControlResponsePb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class RepoAccessControlResponseDeserializer
      extends JsonDeserializer<RepoAccessControlResponse> {
    @Override
    public RepoAccessControlResponse deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException {
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      RepoAccessControlResponsePb pb = mapper.readValue(p, RepoAccessControlResponsePb.class);
      return RepoAccessControlResponse.fromPb(pb);
    }
  }
}
