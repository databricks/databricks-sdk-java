...
@Generated
public class CreateAzureKeyInfo {
  /**
  ...
  public CreateAzureKeyInfo setDiskEncryptionSetId(String diskEncryptionSetId) {
  ...
  public CreateAzureKeyInfo setKeyAccessConfiguration(
  ...
  public CreateAzureKeyInfo setKeyName(String keyName) {
  ...
  public CreateAzureKeyInfo setKeyVaultUri(String keyVaultUri) {
  ...
  public CreateAzureKeyInfo setTenantId(String tenantId) {
  ...
  public CreateAzureKeyInfo setVersion(String version) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAzureKeyInfo that = (CreateAzureKeyInfo) o;
  ...
  public String toString() {
    return new ToStringer(CreateAzureKeyInfo.class)
