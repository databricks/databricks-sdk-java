 ...
 */
@Generated
class GcpManagedNetworkConfigPb {
  ...
  public GcpManagedNetworkConfigPb setGkeClusterPodIpRange(String gkeClusterPodIpRange) {
  ...
  public GcpManagedNetworkConfigPb setGkeClusterServiceIpRange(String gkeClusterServiceIpRange) {
  ...
  public GcpManagedNetworkConfigPb setSubnetCidr(String subnetCidr) {
  ...
  public boolean equals(Object o) {
    ...
    GcpManagedNetworkConfigPb that = (GcpManagedNetworkConfigPb) o;
  ...
  public String toString() {
    return new ToStringer(GcpManagedNetworkConfigPb.class)
