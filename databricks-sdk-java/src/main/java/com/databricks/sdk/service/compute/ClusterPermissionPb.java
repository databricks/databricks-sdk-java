...
class ClusterPermissionPb {
  ...
  public ClusterPermissionPb setInherited(Boolean inherited) {
  ...
  public ClusterPermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public ClusterPermissionPb setPermissionLevel(ClusterPermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterPermissionPb that = (ClusterPermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(ClusterPermissionPb.class)
