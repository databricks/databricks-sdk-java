 ...
 */
@Generated
public class CleanRoomJarAnalysisReview {
  /** review comment */
  ...
  private CleanRoomJarAnalysisReviewJarAnalysisReviewSubReason reviewSubReason;

  /** collaborator alias of the reviewer */
  @JsonProperty("reviewer_collaborator_alias")
  private String reviewerCollaboratorAlias;

  public CleanRoomJarAnalysisReview setComment(String comment) {
  ...
  public CleanRoomJarAnalysisReview setCreatedAtMillis(Long createdAtMillis) {
  ...
  public CleanRoomJarAnalysisReview setReviewState(
  ...
  public CleanRoomJarAnalysisReview setReviewSubReason(
      CleanRoomJarAnalysisReviewJarAnalysisReviewSubReason reviewSubReason) {
    this.reviewSubReason = reviewSubReason;
    return this;
  }

  public CleanRoomJarAnalysisReviewJarAnalysisReviewSubReason getReviewSubReason() {
    return reviewSubReason;
  }

  public CleanRoomJarAnalysisReview setReviewerCollaboratorAlias(String reviewerCollaboratorAlias) {
  ...
  public boolean equals(Object o) {
    ...
    CleanRoomJarAnalysisReview that = (CleanRoomJarAnalysisReview) o;
  ...
  public String toString() {
    return new ToStringer(CleanRoomJarAnalysisReview.class)
        .add("comment", comment)
