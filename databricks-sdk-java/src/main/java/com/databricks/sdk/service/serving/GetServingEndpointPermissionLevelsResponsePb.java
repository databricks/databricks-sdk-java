...
@Generated
class GetServingEndpointPermissionLevelsResponsePb {
  @JsonProperty("permission_levels")
  private Collection<ServingEndpointPermissionsDescription> permissionLevels;

  public GetServingEndpointPermissionLevelsResponsePb setPermissionLevels(
  ...
  public boolean equals(Object o) {
    ...
    GetServingEndpointPermissionLevelsResponsePb that =
        (GetServingEndpointPermissionLevelsResponsePb) o;
  ...
  public String toString() {
    return new ToStringer(GetServingEndpointPermissionLevelsResponsePb.class)
