...
public class CreateAwsKeyInfo {
  ...
  /**
   * This field applies only if the {@code use_cases} property includes {@code STORAGE}. If this is
   * set to true or omitted, the key is also used to encrypt cluster EBS volumes. If you do not want
   * to use this key for encrypting EBS volumes, set to false.
   */
