...
@Generated
public class DeleteMcpServiceRequest {
  /**
  ...
  public DeleteMcpServiceRequest setEtag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public DeleteMcpServiceRequest setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteMcpServiceRequest that = (DeleteMcpServiceRequest) o;
  ...
  public String toString() {
    return new ToStringer(DeleteMcpServiceRequest.class)
        .add("etag", etag)
        .add("name", name)
        .toString();
  }
