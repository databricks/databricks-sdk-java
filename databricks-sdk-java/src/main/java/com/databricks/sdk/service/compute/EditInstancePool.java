...
public class EditInstancePool {
  ...
  public EditInstancePool setIdleInstanceAutoterminationMinutes(Long idleInstanceAutoterminationMinutes) {
  ...
  public EditInstancePool setInstancePoolFleetAttributes(InstancePoolFleetAttributes instancePoolFleetAttributes) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(awsAttributes, azureAttributes, customTags, diskSpec, enableElasticDisk, gcpAttributes, idleInstanceAutoterminationMinutes, instancePoolFleetAttributes, instancePoolId, instancePoolName, maxCapacity, minIdleInstances, nodeTypeId, preloadedDockerImages, preloadedSparkVersions);
  }
  ...
  public String toString() {
    return new ToStringer(EditInstancePool.class)
      ...
      .add("preloadedSparkVersions", preloadedSparkVersions).toString();
  }
}
