...
public class LogDeliveryConfiguration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, configId, configName, creationTime, credentialsId, deliveryPathPrefix, deliveryStartTime, logDeliveryStatus, logType, outputFormat, status, storageConfigurationId, updateTime, workspaceIdsFilter);
  }
  ...
  public String toString() {
    return new ToStringer(LogDeliveryConfiguration.class)
      ...
      .add("workspaceIdsFilter", workspaceIdsFilter).toString();
  }
}
