...
@JsonSerialize(
    using =
        UpdateLlmProxyPartnerPoweredEnforceRequest
            .UpdateLlmProxyPartnerPoweredEnforceRequestSerializer.class)
@JsonDeserialize(
    using =
        UpdateLlmProxyPartnerPoweredEnforceRequest
            .UpdateLlmProxyPartnerPoweredEnforceRequestDeserializer.class)
public class UpdateLlmProxyPartnerPoweredEnforceRequest {
  ...
  UpdateLlmProxyPartnerPoweredEnforceRequestPb toPb() {
    UpdateLlmProxyPartnerPoweredEnforceRequestPb pb =
        new UpdateLlmProxyPartnerPoweredEnforceRequestPb();
  ...
  static UpdateLlmProxyPartnerPoweredEnforceRequest fromPb(
      UpdateLlmProxyPartnerPoweredEnforceRequestPb pb) {
    UpdateLlmProxyPartnerPoweredEnforceRequest model =
  ...
  public static class UpdateLlmProxyPartnerPoweredEnforceRequestSerializer
      extends JsonSerializer<UpdateLlmProxyPartnerPoweredEnforceRequest> {
    @Override
    public void serialize(
        UpdateLlmProxyPartnerPoweredEnforceRequest value,
        JsonGenerator gen,
        SerializerProvider provider)
        throws IOException {
      UpdateLlmProxyPartnerPoweredEnforceRequestPb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class UpdateLlmProxyPartnerPoweredEnforceRequestDeserializer
      extends JsonDeserializer<UpdateLlmProxyPartnerPoweredEnforceRequest> {
    @Override
    public UpdateLlmProxyPartnerPoweredEnforceRequest deserialize(
        JsonParser p, DeserializationContext ctxt) throws IOException {
      // The Codec is set by us in the SerDeUtils.java, and it is an ObjectMapper.
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      UpdateLlmProxyPartnerPoweredEnforceRequestPb pb =
          mapper.readValue(p, UpdateLlmProxyPartnerPoweredEnforceRequestPb.class);
      return UpdateLlmProxyPartnerPoweredEnforceRequest.fromPb(pb);
    }
  }
}
