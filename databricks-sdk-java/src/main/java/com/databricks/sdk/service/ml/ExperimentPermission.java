...
public class ExperimentPermission {
  ...
  public ExperimentPermission setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public ExperimentPermission setPermissionLevel(ExperimentPermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    ExperimentPermission that = (ExperimentPermission) o;
  ...
  public String toString() {
    return new ToStringer(ExperimentPermission.class)
