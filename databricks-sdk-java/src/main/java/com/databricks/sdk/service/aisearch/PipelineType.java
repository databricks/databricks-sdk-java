 ...
 *
 * <ul>
 *   <li>{@code TRIGGERED}: the pipeline stops after refreshing the source table once, using the
 *       data available when the update started.
 *   <li>{@code CONTINUOUS}: the pipeline processes new data as it arrives in the source table to
