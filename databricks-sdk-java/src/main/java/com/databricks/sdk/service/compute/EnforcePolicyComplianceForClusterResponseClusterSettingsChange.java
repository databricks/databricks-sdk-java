 ...
 */
@Generated
public class EnforcePolicyComplianceForClusterResponseClusterSettingsChange {
  ...
  public EnforcePolicyComplianceForClusterResponseClusterSettingsChange setField(String field) {
    this.field = field;
    return this;
  }
  ...
  public EnforcePolicyComplianceForClusterResponseClusterSettingsChange setNewValue(
      String newValue) {
  ...
  public EnforcePolicyComplianceForClusterResponseClusterSettingsChange setPreviousValue(
  ...
  public boolean equals(Object o) {
    ...
    EnforcePolicyComplianceForClusterResponseClusterSettingsChange that =
        (EnforcePolicyComplianceForClusterResponseClusterSettingsChange) o;
  ...
  public String toString() {
    return new ToStringer(EnforcePolicyComplianceForClusterResponseClusterSettingsChange.class)
        .add("field", field)
