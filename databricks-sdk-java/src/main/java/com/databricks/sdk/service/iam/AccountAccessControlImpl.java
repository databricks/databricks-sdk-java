...
class AccountAccessControlImpl implements AccountAccessControlService {
  ...
  public GetAssignableRolesForResourceResponse getAssignableRolesForResource(GetAssignableRolesForResourceRequest request) {
    String path = String.format("/api/2.0/preview/accounts/%s/access-control/assignable-roles", apiClient.configuredAccountID());
  ...
  public RuleSetResponse getRuleSet(GetRuleSetRequest request) {
    String path = String.format("/api/2.0/preview/accounts/%s/access-control/rule-sets", apiClient.configuredAccountID());
