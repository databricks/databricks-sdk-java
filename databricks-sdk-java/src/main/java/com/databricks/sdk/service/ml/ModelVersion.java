...
public class ModelVersion {
  /** Timestamp recorded when this {@code model_version} was created. */
  @JsonProperty("creation_timestamp")
  private Long creationTimestamp;

  /** Current stage for this {@code model_version}. */
  @JsonProperty("current_stage")
  private String currentStage;

  /** Description of this {@code model_version}. */
  ...
  /**
   * MLflow run ID used when creating {@code model_version}, if {@code source} was generated by an
  ...
  /**
   * URI indicating the location of the source model artifacts, used when creating {@code
   * model_version}
   */
  @JsonProperty("source")
  private String source;

  /** Current status of {@code model_version} */
  @JsonProperty("status")
  private ModelVersionStatus status;

  /** Details on current {@code status}, if it is pending or failed. */
  @JsonProperty("status_message")
  private String statusMessage;

  /** Tags: Additional metadata key-value pairs for this {@code model_version}. */
  @JsonProperty("tags")
  private Collection<ModelVersionTag> tags;

  /** User that created this {@code model_version}. */
