...
class CreateFileRequestPb {
  ...
  public CreateFileRequestPb setDisplayName(String displayName) {
  ...
  public CreateFileRequestPb setFileParent(FileParent fileParent) {
  ...
  public CreateFileRequestPb setMarketplaceFileType(MarketplaceFileType marketplaceFileType) {
  ...
  public CreateFileRequestPb setMimeType(String mimeType) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFileRequestPb that = (CreateFileRequestPb) o;
  ...
  public String toString() {
    return new ToStringer(CreateFileRequestPb.class)
