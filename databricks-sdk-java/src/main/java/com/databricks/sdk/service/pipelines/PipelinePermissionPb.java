...
class PipelinePermissionPb {
  ...
  public PipelinePermissionPb setInherited(Boolean inherited) {
  ...
  public PipelinePermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public PipelinePermissionPb setPermissionLevel(PipelinePermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    PipelinePermissionPb that = (PipelinePermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(PipelinePermissionPb.class)
