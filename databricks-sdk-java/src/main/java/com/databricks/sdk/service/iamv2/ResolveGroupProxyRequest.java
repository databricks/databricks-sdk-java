...
public class ResolveGroupProxyRequest {
  ...
  public ResolveGroupProxyRequest setExternalId(String externalId) {
  ...
  public boolean equals(Object o) {
    ...
    ResolveGroupProxyRequest that = (ResolveGroupProxyRequest) o;
  ...
  public String toString() {
    return new ToStringer(ResolveGroupProxyRequest.class).add("externalId", externalId).toString();
  }
}
