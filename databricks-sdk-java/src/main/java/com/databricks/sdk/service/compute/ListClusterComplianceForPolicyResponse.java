...
@Generated
public class ListClusterComplianceForPolicyResponse {
  ...
  public ListClusterComplianceForPolicyResponse setClusters(
      Collection<ClusterCompliance> clusters) {
  ...
  public ListClusterComplianceForPolicyResponse setNextPageToken(String nextPageToken) {
  ...
  public ListClusterComplianceForPolicyResponse setPrevPageToken(String prevPageToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListClusterComplianceForPolicyResponse that = (ListClusterComplianceForPolicyResponse) o;
  ...
  public String toString() {
    return new ToStringer(ListClusterComplianceForPolicyResponse.class)
