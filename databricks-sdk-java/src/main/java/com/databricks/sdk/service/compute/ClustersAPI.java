...
public class ClustersAPI {
  ...
  public ClusterDetails waitGetClusterRunning(String clusterId)
    throws TimeoutException {
    return waitGetClusterRunning(clusterId, Duration.ofMinutes(20), null);
  }

  public ClusterDetails waitGetClusterRunning(String clusterId, 
    Duration timeout,  Consumer<ClusterDetails> callback) throws TimeoutException {
  ...
  public ClusterDetails waitGetClusterTerminated(String clusterId)
    throws TimeoutException {
  ...
  public void changeOwner(String clusterId, String ownerUsername) {
    changeOwner(new ChangeClusterOwner()
  ...
  public Wait<ClusterDetails,CreateClusterResponse> create(String sparkVersion) {
    return create(new CreateCluster()
  ...
  public Wait<ClusterDetails,CreateClusterResponse> create(CreateCluster request) {
    ...
    return new Wait<>((timeout, callback) -> waitGetClusterRunning(response.getClusterId(), timeout, callback), response);
  }
  
	
  public Wait<ClusterDetails,Void> delete(String clusterId) {
    return delete(new DeleteCluster()
      .setClusterId(clusterId));
  }
  ...
  public Wait<ClusterDetails,Void> delete(DeleteCluster request) {
    impl.delete(request);
    return new Wait<>((timeout, callback) -> waitGetClusterTerminated(request.getClusterId(), timeout, callback));
  }
  
	
  public Wait<ClusterDetails,Void> edit(String clusterId, String sparkVersion) {
    return edit(new EditCluster()
      .setClusterId(clusterId)
      .setSparkVersion(sparkVersion));
  }
  ...
  public Wait<ClusterDetails,Void> edit(EditCluster request) {
    impl.edit(request);
    return new Wait<>((timeout, callback) -> waitGetClusterRunning(request.getClusterId(), timeout, callback));
  }
  
	
  public Iterable<ClusterEvent> events(String clusterId) {
    return events(new GetEvents()
      .setClusterId(clusterId));
  }
  ...
  public Iterable<ClusterEvent> events(GetEvents request) {
    return new Paginator<>(request, impl::events, GetEventsResponse::getEvents, response -> {
  ...
  public ClusterDetails get(String clusterId) {
    return get(new GetClusterRequest()
      .setClusterId(clusterId));
  }
   ...
   * the most recently terminated all-purpose clusters in the past 30 days, and
   * up to 30 of the most recently terminated job clusters in the past 30 days.
   * 
  ...
  public void permanentDelete(String clusterId) {
    permanentDelete(new PermanentDeleteCluster()
      .setClusterId(clusterId));
  }
  ...
  public Wait<ClusterDetails,Void> resize(String clusterId) {
    return resize(new ResizeCluster()
      .setClusterId(clusterId));
  }
  ...
  public Wait<ClusterDetails,Void> restart(String clusterId) {
    return restart(new RestartCluster()
      .setClusterId(clusterId));
  }
