...
public class TokenPermission {
  ...
  public TokenPermission setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public TokenPermission setPermissionLevel(TokenPermissionLevel permissionLevel) {
  ...
  public String toString() {
    return new ToStringer(TokenPermission.class)
