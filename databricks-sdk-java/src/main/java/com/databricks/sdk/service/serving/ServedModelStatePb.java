...
class ServedModelStatePb {
  ...
  public ServedModelStatePb setDeployment(ServedModelStateDeployment deployment) {
  ...
  public ServedModelStatePb setDeploymentStateMessage(String deploymentStateMessage) {
  ...
  public boolean equals(Object o) {
    ...
    ServedModelStatePb that = (ServedModelStatePb) o;
  ...
  public String toString() {
    return new ToStringer(ServedModelStatePb.class)
