...
public class JobSpecWithoutSecret {
  ...
  /**
   * URL of the workspace containing the job that this webhook runs. Defaults to
   * the workspace URL in which the webhook is created. If not specified, the
   * job’s workspace is assumed to be the same as the webhook’s.
   */
