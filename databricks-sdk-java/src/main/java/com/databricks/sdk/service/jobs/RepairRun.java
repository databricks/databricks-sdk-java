...
public class RepairRun {
  ...
  /**
   * If true, repair all failed tasks. Only one of {@code rerun_tasks} or {@code
  ...
  /**
   * If true, repair all tasks that depend on the tasks in {@code rerun_tasks}, even if they were
   * previously successful. Can be also used in combination with {@code rerun_all_failed_tasks}.
   */
