...
class ChannelInfoPb {
  ...
  public ChannelInfoPb setDbsqlVersion(String dbsqlVersion) {
  ...
  public ChannelInfoPb setName(ChannelName name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChannelInfoPb that = (ChannelInfoPb) o;
  ...
  public String toString() {
    return new ToStringer(ChannelInfoPb.class)
