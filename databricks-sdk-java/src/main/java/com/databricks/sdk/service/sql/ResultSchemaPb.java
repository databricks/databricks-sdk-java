...
class ResultSchemaPb {
  ...
  public ResultSchemaPb setColumnCount(Long columnCount) {
  ...
  public ResultSchemaPb setColumns(Collection<ColumnInfo> columns) {
  ...
  public boolean equals(Object o) {
    ...
    ResultSchemaPb that = (ResultSchemaPb) o;
  ...
  public String toString() {
    return new ToStringer(ResultSchemaPb.class)
