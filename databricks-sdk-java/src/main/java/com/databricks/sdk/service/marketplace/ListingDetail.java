...
public class ListingDetail {
   ...
   *
   * <ol>
   *   <li>If the field is optional and won't need to have NOT NULL integrity check
   *   <li>The value is fairly fixed, static and low cardinality (eg. enums).
   *   <li>The value won't be used in filters or joins with other tables.
   * </ol>
   */
  @JsonProperty("tags")
