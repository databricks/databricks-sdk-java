...
public class DataModificationResult {
  ...
  public DataModificationResult setFailedPrimaryKeys(Collection<String> failedPrimaryKeys) {
  ...
  public DataModificationResult setSuccessRowCount(Long successRowCount) {
  ...
  public boolean equals(Object o) {
    ...
    DataModificationResult that = (DataModificationResult) o;
  ...
  public String toString() {
    return new ToStringer(DataModificationResult.class)
