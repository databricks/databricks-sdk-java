...
public class FirstNFunction {
  ...
  public FirstNFunction setInput(String input) {
    this.input = input;
    return this;
  }
  ...
  public FirstNFunction setN(Long n) {
    this.n = n;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirstNFunction that = (FirstNFunction) o;
  ...
  public String toString() {
    return new ToStringer(FirstNFunction.class).add("input", input).add("n", n).toString();
  }
}
