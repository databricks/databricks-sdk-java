...
@Generated
@JsonSerialize(using = PutAiGatewayResponse.PutAiGatewayResponseSerializer.class)
@JsonDeserialize(using = PutAiGatewayResponse.PutAiGatewayResponseDeserializer.class)
public class PutAiGatewayResponse {
  ...
  PutAiGatewayResponsePb toPb() {
    PutAiGatewayResponsePb pb = new PutAiGatewayResponsePb();
  ...
  static PutAiGatewayResponse fromPb(PutAiGatewayResponsePb pb) {
    PutAiGatewayResponse model = new PutAiGatewayResponse();
  ...
  public static class PutAiGatewayResponseSerializer extends JsonSerializer<PutAiGatewayResponse> {
    @Override
    public void serialize(
        PutAiGatewayResponse value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      PutAiGatewayResponsePb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class PutAiGatewayResponseDeserializer
      extends JsonDeserializer<PutAiGatewayResponse> {
    @Override
    public PutAiGatewayResponse deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException {
      // The Codec is set by us in the SerDeUtils.java, and it is an ObjectMapper.
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      PutAiGatewayResponsePb pb = mapper.readValue(p, PutAiGatewayResponsePb.class);
      return PutAiGatewayResponse.fromPb(pb);
    }
  }
}
