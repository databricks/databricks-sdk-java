...
@Generated
class JobNotificationSettingsPb {
  ...
  public JobNotificationSettingsPb setNoAlertForCanceledRuns(Boolean noAlertForCanceledRuns) {
  ...
  public JobNotificationSettingsPb setNoAlertForSkippedRuns(Boolean noAlertForSkippedRuns) {
  ...
  public boolean equals(Object o) {
    ...
    JobNotificationSettingsPb that = (JobNotificationSettingsPb) o;
  ...
  public String toString() {
    return new ToStringer(JobNotificationSettingsPb.class)
