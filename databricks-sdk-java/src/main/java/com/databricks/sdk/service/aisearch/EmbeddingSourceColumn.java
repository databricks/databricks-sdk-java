...
public class EmbeddingSourceColumn {
  ...
  @JsonProperty("embedding_model_endpoint")
  ...
  public EmbeddingSourceColumn setEmbeddingModelEndpoint(String embeddingModelEndpoint) {
    this.embeddingModelEndpoint = embeddingModelEndpoint;
    return this;
  }

  public String getEmbeddingModelEndpoint() {
    return embeddingModelEndpoint;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(embeddingModelEndpoint, that.embeddingModelEndpoint)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(embeddingModelEndpoint, modelEndpointNameForQuery, name);
  }

  @Override
  public String toString() {
    return new ToStringer(EmbeddingSourceColumn.class)
        .add("embeddingModelEndpoint", embeddingModelEndpoint)
