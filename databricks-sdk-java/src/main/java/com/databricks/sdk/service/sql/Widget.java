...
public class Widget {
   ...
   * visualization by copying description objects received <i>from the API</i> and then using them
   * to create a new one with a POST request to the same endpoint. Databricks does not recommend
