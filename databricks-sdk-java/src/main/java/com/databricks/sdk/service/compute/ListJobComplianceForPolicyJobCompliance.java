...
@Generated
public class ListJobComplianceForPolicyJobCompliance {
  ...
  public ListJobComplianceForPolicyJobCompliance setIsCompliant(Boolean isCompliant) {
  ...
  public ListJobComplianceForPolicyJobCompliance setJobId(Long jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public ListJobComplianceForPolicyJobCompliance setViolations(Map<String, String> violations) {
  ...
  public boolean equals(Object o) {
    ...
    ListJobComplianceForPolicyJobCompliance that = (ListJobComplianceForPolicyJobCompliance) o;
  ...
  public String toString() {
    return new ToStringer(ListJobComplianceForPolicyJobCompliance.class)
