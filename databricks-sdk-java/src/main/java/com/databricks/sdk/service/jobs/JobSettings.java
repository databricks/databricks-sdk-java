...
public class JobSettings {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(compute, continuous, emailNotifications, format, gitSource, jobClusters, maxConcurrentRuns, name, notificationSettings, parameters, runAs, schedule, tags, tasks, timeoutSeconds, trigger, webhookNotifications);
  }
