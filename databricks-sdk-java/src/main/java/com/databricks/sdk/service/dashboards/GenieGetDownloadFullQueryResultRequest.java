...
public class GenieGetDownloadFullQueryResultRequest {
  ...
  @JsonIgnore
  @QueryParam("download_id_signature")
  ...
  public GenieGetDownloadFullQueryResultRequest setDownloadIdSignature(String downloadIdSignature) {
  ...
  public int hashCode() {
    return Objects.hash(
        attachmentId, conversationId, downloadId, downloadIdSignature, messageId, spaceId);
  }
