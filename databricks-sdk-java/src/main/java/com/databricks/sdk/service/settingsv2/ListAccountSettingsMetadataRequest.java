...
public class ListAccountSettingsMetadataRequest {
  ...
  /**
   * A page token, received from a previous {@code ListAccountSettingsMetadataRequest} call. Provide
   * this to retrieve the subsequent page.
   *
   * <p>When paginating, all other parameters provided to {@code ListAccountSettingsMetadataRequest}
