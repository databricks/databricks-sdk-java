 ...
 */
@Generated
class DatabaseInstanceRoleAttributesPb {
  ...
  public DatabaseInstanceRoleAttributesPb setBypassrls(Boolean bypassrls) {
  ...
  public DatabaseInstanceRoleAttributesPb setCreatedb(Boolean createdb) {
  ...
  public DatabaseInstanceRoleAttributesPb setCreaterole(Boolean createrole) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseInstanceRoleAttributesPb that = (DatabaseInstanceRoleAttributesPb) o;
  ...
  public String toString() {
    return new ToStringer(DatabaseInstanceRoleAttributesPb.class)
