...
public class ResolvedValues {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(conditionTask, dbtTask, notebookTask, pythonWheelTask, runJobTask, simulationTask, sparkJarTask, sparkPythonTask, sparkSubmitTask, sqlTask);
  }
