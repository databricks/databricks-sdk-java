...
public class SharePermissionsRequest {
   ...
   *   <li>If not set, all valid permissions are returned (not recommended).
   *   <li>Note: The number of returned permissions might be less than the specified max_results
   *       size, even zero. The only definitive indication that no further permissions can be
