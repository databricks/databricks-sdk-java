...
@Generated
@JsonSerialize(using = GetInstancePool.GetInstancePoolSerializer.class)
@JsonDeserialize(using = GetInstancePool.GetInstancePoolDeserializer.class)
public class GetInstancePool {
  ...
  GetInstancePoolPb toPb() {
    GetInstancePoolPb pb = new GetInstancePoolPb();
  ...
  static GetInstancePool fromPb(GetInstancePoolPb pb) {
    GetInstancePool model = new GetInstancePool();
  ...
  public static class GetInstancePoolSerializer extends JsonSerializer<GetInstancePool> {
    @Override
    public void serialize(GetInstancePool value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      GetInstancePoolPb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class GetInstancePoolDeserializer extends JsonDeserializer<GetInstancePool> {
    @Override
    public GetInstancePool deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException {
      // The Codec is set by us in the SerDeUtils.java, and it is an ObjectMapper.
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      GetInstancePoolPb pb = mapper.readValue(p, GetInstancePoolPb.class);
      return GetInstancePool.fromPb(pb);
    }
  }
}
