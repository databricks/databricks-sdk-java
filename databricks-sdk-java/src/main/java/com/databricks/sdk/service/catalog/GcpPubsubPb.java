...
class GcpPubsubPb {
  ...
  public GcpPubsubPb setManagedResourceId(String managedResourceId) {
  ...
  public GcpPubsubPb setSubscriptionName(String subscriptionName) {
  ...
  public boolean equals(Object o) {
    ...
    GcpPubsubPb that = (GcpPubsubPb) o;
  ...
  public String toString() {
    return new ToStringer(GcpPubsubPb.class)
