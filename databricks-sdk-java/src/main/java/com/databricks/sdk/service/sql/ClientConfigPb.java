...
class ClientConfigPb {
  ...
  public ClientConfigPb setAllowCustomJsVisualizations(Boolean allowCustomJsVisualizations) {
  ...
  public ClientConfigPb setAllowDownloads(Boolean allowDownloads) {
  ...
  public ClientConfigPb setAllowExternalShares(Boolean allowExternalShares) {
  ...
  public ClientConfigPb setAllowSubscriptions(Boolean allowSubscriptions) {
  ...
  public ClientConfigPb setDateFormat(String dateFormat) {
  ...
  public ClientConfigPb setDateTimeFormat(String dateTimeFormat) {
  ...
  public ClientConfigPb setDisablePublish(Boolean disablePublish) {
  ...
  public ClientConfigPb setEnableLegacyAutodetectTypes(Boolean enableLegacyAutodetectTypes) {
  ...
  public ClientConfigPb setFeatureShowPermissionsControl(Boolean featureShowPermissionsControl) {
  ...
  public ClientConfigPb setHidePlotlyModeBar(Boolean hidePlotlyModeBar) {
  ...
  public boolean equals(Object o) {
    ...
    ClientConfigPb that = (ClientConfigPb) o;
  ...
  public String toString() {
    return new ToStringer(ClientConfigPb.class)
