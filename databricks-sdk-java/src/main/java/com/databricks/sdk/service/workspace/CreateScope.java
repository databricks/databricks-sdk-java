...
public class CreateScope {
  ...
  /** The principal that is initially granted {@code MANAGE} permission to the created scope. */
  ...
  /**
   * The backend type the scope will be created with. If not specified, will default to {@code
   * DATABRICKS}
   */
