...
@Generated
public class EnforcePolicyComplianceForJobResponse {
  /**
  ...
  private com.databricks.sdk.service.jobs.JobSettings settings;

  public EnforcePolicyComplianceForJobResponse setHasChanges(Boolean hasChanges) {
  ...
  public EnforcePolicyComplianceForJobResponse setJobClusterChanges(
  ...
  public EnforcePolicyComplianceForJobResponse setSettings(
      com.databricks.sdk.service.jobs.JobSettings settings) {
    this.settings = settings;
    return this;
  }

  public com.databricks.sdk.service.jobs.JobSettings getSettings() {
    return settings;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnforcePolicyComplianceForJobResponse that = (EnforcePolicyComplianceForJobResponse) o;
  ...
  public String toString() {
    return new ToStringer(EnforcePolicyComplianceForJobResponse.class)
