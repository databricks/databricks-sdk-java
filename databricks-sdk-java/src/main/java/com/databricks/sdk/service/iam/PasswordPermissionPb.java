...
class PasswordPermissionPb {
  ...
  public PasswordPermissionPb setInherited(Boolean inherited) {
  ...
  public PasswordPermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public PasswordPermissionPb setPermissionLevel(PasswordPermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    PasswordPermissionPb that = (PasswordPermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(PasswordPermissionPb.class)
