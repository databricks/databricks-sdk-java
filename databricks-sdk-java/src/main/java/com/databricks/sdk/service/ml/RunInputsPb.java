...
class RunInputsPb {
  ...
  public RunInputsPb setDatasetInputs(Collection<DatasetInput> datasetInputs) {
  ...
  public RunInputsPb setModelInputs(Collection<ModelInput> modelInputs) {
  ...
  public boolean equals(Object o) {
    ...
    RunInputsPb that = (RunInputsPb) o;
  ...
  public String toString() {
    return new ToStringer(RunInputsPb.class)
