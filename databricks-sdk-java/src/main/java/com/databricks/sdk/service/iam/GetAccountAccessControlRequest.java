...
/** Get a rule set */
@Generated
public class GetAccountAccessControlRequest {
  /**
  ...
  public GetAccountAccessControlRequest setEtag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public GetAccountAccessControlRequest setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAccountAccessControlRequest that = (GetAccountAccessControlRequest) o;
  ...
  public String toString() {
    return new ToStringer(GetAccountAccessControlRequest.class)
        .add("etag", etag)
        .add("name", name)
        .toString();
  }
