...
public class TableSummariesRequest {
  ...
  /**
   * Optional. A sql LIKE pattern (% and _) for schema names. All schemas will be returned if not
   * set or empty.
   */
  ...
  /**
   * Optional. A sql LIKE pattern (% and _) for table names. All tables will be returned if not set
   * or empty.
   */
