...
/** List job runs */
@Generated
@JsonSerialize(using = ListRunsRequest.ListRunsRequestSerializer.class)
@JsonDeserialize(using = ListRunsRequest.ListRunsRequestDeserializer.class)
public class ListRunsRequest {
  ...
  ListRunsRequestPb toPb() {
    ListRunsRequestPb pb = new ListRunsRequestPb();
    pb.setActiveOnly(activeOnly);
    pb.setCompletedOnly(completedOnly);
    ...
    pb.setStartTimeFrom(startTimeFrom);
    pb.setStartTimeTo(startTimeTo);

    return pb;
  }

  static ListRunsRequest fromPb(ListRunsRequestPb pb) {
    ListRunsRequest model = new ListRunsRequest();
    model.setActiveOnly(pb.getActiveOnly());
    model.setCompletedOnly(pb.getCompletedOnly());
    ...
    model.setStartTimeFrom(pb.getStartTimeFrom());
    model.setStartTimeTo(pb.getStartTimeTo());

    return model;
  }

  public static class ListRunsRequestSerializer extends JsonSerializer<ListRunsRequest> {
    @Override
    public void serialize(ListRunsRequest value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      ListRunsRequestPb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class ListRunsRequestDeserializer extends JsonDeserializer<ListRunsRequest> {
    @Override
    public ListRunsRequest deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException {
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      ListRunsRequestPb pb = mapper.readValue(p, ListRunsRequestPb.class);
      return ListRunsRequest.fromPb(pb);
    }
  }
}
