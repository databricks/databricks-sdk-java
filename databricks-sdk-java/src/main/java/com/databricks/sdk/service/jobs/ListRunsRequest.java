...
public class ListRunsRequest {
   ...
   * results; otherwise, lists both active and completed runs. This field cannot
   * be `true` when active_only is `true`.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeOnly, completedOnly, expandTasks, jobId, limit, offset, pageToken, runType, startTimeFrom, startTimeTo);
  }
  ...
  public String toString() {
    return new ToStringer(ListRunsRequest.class)
      ...
      .add("startTimeTo", startTimeTo).toString();
  }
}
