...
class NetworkPolicyEgressPb {
  ...
  public boolean equals(Object o) {
    ...
    NetworkPolicyEgressPb that = (NetworkPolicyEgressPb) o;
  ...
  public String toString() {
    return new ToStringer(NetworkPolicyEgressPb.class)
        .add("networkAccess", networkAccess)
        .toString();
  }
}
