...
class JobPermissionPb {
  ...
  public JobPermissionPb setInherited(Boolean inherited) {
  ...
  public JobPermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public JobPermissionPb setPermissionLevel(JobPermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    JobPermissionPb that = (JobPermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(JobPermissionPb.class)
