...
@Generated
class GetIpAccessListsResponsePb {
  @JsonProperty("ip_access_lists")
  private Collection<IpAccessListInfo> ipAccessLists;

  public GetIpAccessListsResponsePb setIpAccessLists(Collection<IpAccessListInfo> ipAccessLists) {
  ...
  public boolean equals(Object o) {
    ...
    GetIpAccessListsResponsePb that = (GetIpAccessListsResponsePb) o;
  ...
  public String toString() {
    return new ToStringer(GetIpAccessListsResponsePb.class)
