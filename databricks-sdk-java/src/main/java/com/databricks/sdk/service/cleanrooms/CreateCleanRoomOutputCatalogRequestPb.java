...
@Generated
class CreateCleanRoomOutputCatalogRequestPb {
  @JsonIgnore private String cleanRoomName;

  @JsonProperty("output_catalog")
  private CleanRoomOutputCatalog outputCatalog;

  public CreateCleanRoomOutputCatalogRequestPb setCleanRoomName(String cleanRoomName) {
  ...
  public CreateCleanRoomOutputCatalogRequestPb setOutputCatalog(
  ...
  public boolean equals(Object o) {
    ...
    CreateCleanRoomOutputCatalogRequestPb that = (CreateCleanRoomOutputCatalogRequestPb) o;
  ...
  public String toString() {
    return new ToStringer(CreateCleanRoomOutputCatalogRequestPb.class)
