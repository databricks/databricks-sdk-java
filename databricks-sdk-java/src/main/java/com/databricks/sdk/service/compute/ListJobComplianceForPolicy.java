...
@Generated
public class ListJobComplianceForPolicy {
  /**
  ...
  public ListJobComplianceForPolicy setPageSize(Long pageSize) {
  ...
  public ListJobComplianceForPolicy setPageToken(String pageToken) {
  ...
  public ListJobComplianceForPolicy setPolicyId(String policyId) {
  ...
  public boolean equals(Object o) {
    ...
    ListJobComplianceForPolicy that = (ListJobComplianceForPolicy) o;
  ...
  public String toString() {
    return new ToStringer(ListJobComplianceForPolicy.class)
