...
@Generated
class EncryptionDetailsPb {
  @JsonProperty("sse_encryption_details")
  private SseEncryptionDetails sseEncryptionDetails;

  public EncryptionDetailsPb setSseEncryptionDetails(SseEncryptionDetails sseEncryptionDetails) {
  ...
  public boolean equals(Object o) {
    ...
    EncryptionDetailsPb that = (EncryptionDetailsPb) o;
  ...
  public String toString() {
    return new ToStringer(EncryptionDetailsPb.class)
