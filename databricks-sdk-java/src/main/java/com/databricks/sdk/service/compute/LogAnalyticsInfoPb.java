...
class LogAnalyticsInfoPb {
  ...
  public LogAnalyticsInfoPb setLogAnalyticsPrimaryKey(String logAnalyticsPrimaryKey) {
  ...
  public LogAnalyticsInfoPb setLogAnalyticsWorkspaceId(String logAnalyticsWorkspaceId) {
  ...
  public boolean equals(Object o) {
    ...
    LogAnalyticsInfoPb that = (LogAnalyticsInfoPb) o;
  ...
  public String toString() {
    return new ToStringer(LogAnalyticsInfoPb.class)
