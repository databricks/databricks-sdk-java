...
public class ListMetastoresRequest {
   ...
   *   <li>If not set, all the metastores are returned (not recommended).
   *   <li>Note: The number of returned metastores might be less than the specified max_results
   *       size, even zero. The only definitive indication that no further metastores can be fetched
