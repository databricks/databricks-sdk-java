...
@Generated
public class BundleDeploymentsAPI {
  private static final Logger LOG = LoggerFactory.getLogger(BundleDeploymentsAPI.class);

  private final BundleDeploymentsService impl;

  /** Regular-use constructor */
  public BundleDeploymentsAPI(ApiClient apiClient) {
    impl = new BundleDeploymentsImpl(apiClient);
  }

  /** Constructor for mocks */
  public BundleDeploymentsAPI(BundleDeploymentsService mock) {
    impl = mock;
  }
  ...
  public BundleDeploymentsService impl() {
    return impl;
  }
}
