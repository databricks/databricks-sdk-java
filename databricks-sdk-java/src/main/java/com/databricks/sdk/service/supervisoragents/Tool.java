...
public class Tool {
   ...
   * "uc_connection", "uc_mcp", "app", "volume", "dashboard", "serving_endpoint", "table",
   * "vector_search_index", "catalog", "schema", "supervisor_agent", "databricks_web_search",
   * "skill". The legacy values "lakeview_dashboard", "uc_table", and "web_search" are also accepted
   * and remain equivalent to "dashboard", "table", and "databricks_web_search" respectively. The
