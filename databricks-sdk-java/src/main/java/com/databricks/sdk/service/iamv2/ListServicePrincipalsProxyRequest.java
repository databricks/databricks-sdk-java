...
public class ListServicePrincipalsProxyRequest {
  ...
  /**
   * The maximum number of SPs to return. The service may return fewer than this value. If not
  ...
  public ListServicePrincipalsProxyRequest setFilter(String filter) {
    this.filter = filter;
    return this;
  }
