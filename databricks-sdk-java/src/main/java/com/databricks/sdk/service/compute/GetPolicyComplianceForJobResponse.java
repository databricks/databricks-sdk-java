...
@Generated
public class GetPolicyComplianceForJobResponse {
  /**
  ...
  public GetPolicyComplianceForJobResponse setIsCompliant(Boolean isCompliant) {
  ...
  public GetPolicyComplianceForJobResponse setViolations(Map<String, String> violations) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyComplianceForJobResponse that = (GetPolicyComplianceForJobResponse) o;
  ...
  public String toString() {
    return new ToStringer(GetPolicyComplianceForJobResponse.class)
