...
@JsonSerialize(
    using =
        UpdateLlmProxyPartnerPoweredAccountRequest
            .UpdateLlmProxyPartnerPoweredAccountRequestSerializer.class)
@JsonDeserialize(
    using =
        UpdateLlmProxyPartnerPoweredAccountRequest
            .UpdateLlmProxyPartnerPoweredAccountRequestDeserializer.class)
public class UpdateLlmProxyPartnerPoweredAccountRequest {
  ...
  UpdateLlmProxyPartnerPoweredAccountRequestPb toPb() {
    UpdateLlmProxyPartnerPoweredAccountRequestPb pb =
        new UpdateLlmProxyPartnerPoweredAccountRequestPb();
  ...
  static UpdateLlmProxyPartnerPoweredAccountRequest fromPb(
      UpdateLlmProxyPartnerPoweredAccountRequestPb pb) {
    UpdateLlmProxyPartnerPoweredAccountRequest model =
  ...
  public static class UpdateLlmProxyPartnerPoweredAccountRequestSerializer
      extends JsonSerializer<UpdateLlmProxyPartnerPoweredAccountRequest> {
    @Override
    public void serialize(
        UpdateLlmProxyPartnerPoweredAccountRequest value,
        JsonGenerator gen,
        SerializerProvider provider)
        throws IOException {
      UpdateLlmProxyPartnerPoweredAccountRequestPb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class UpdateLlmProxyPartnerPoweredAccountRequestDeserializer
      extends JsonDeserializer<UpdateLlmProxyPartnerPoweredAccountRequest> {
    @Override
    public UpdateLlmProxyPartnerPoweredAccountRequest deserialize(
      ...
      return UpdateLlmProxyPartnerPoweredAccountRequest.fromPb(pb);
    }
  }
}
