...
@Generated
class InstancePoolPermissionPb {
  ...
  public InstancePoolPermissionPb setInherited(Boolean inherited) {
  ...
  public InstancePoolPermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public InstancePoolPermissionPb setPermissionLevel(InstancePoolPermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    InstancePoolPermissionPb that = (InstancePoolPermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(InstancePoolPermissionPb.class)
