...
public class EditCluster {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applyPolicyDefaultValues, autoscale, autoterminationMinutes, awsAttributes, azureAttributes, clusterId, clusterLogConf, clusterName, clusterSource, customTags, dataSecurityMode, dockerImage, driverInstancePoolId, driverNodeTypeId, enableElasticDisk, enableLocalDiskEncryption, gcpAttributes, initScripts, instancePoolId, nodeTypeId, numWorkers, policyId, runtimeEngine, singleUserName, sparkConf, sparkEnvVars, sparkVersion, sshPublicKeys, workloadType);
  }
