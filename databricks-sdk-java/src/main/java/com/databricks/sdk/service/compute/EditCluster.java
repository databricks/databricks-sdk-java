...
@Generated
@JsonSerialize(using = EditCluster.EditClusterSerializer.class)
@JsonDeserialize(using = EditCluster.EditClusterDeserializer.class)
public class EditCluster {
  ...
  public EditCluster setIsSingleNode(Boolean isSingleNode) {
  ...
  public EditCluster setKind(Kind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public EditCluster setSshPublicKeys(Collection<String> sshPublicKeys) {
  ...
  public boolean equals(Object o) {
    ...
    EditCluster that = (EditCluster) o;
  ...
  public String toString() {
    return new ToStringer(EditCluster.class)
  ...
  EditClusterPb toPb() {
    EditClusterPb pb = new EditClusterPb();
  ...
  static EditCluster fromPb(EditClusterPb pb) {
    EditCluster model = new EditCluster();
  ...
  public static class EditClusterSerializer extends JsonSerializer<EditCluster> {
    @Override
    public void serialize(EditCluster value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      EditClusterPb pb = value.toPb();
