...
public class QueryMetrics {
  ...
  /**
   * Time waiting for compute resources to be provisioned for the SQL warehouse,
   * in milliseconds.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(compilationTimeMs, executionTimeMs, networkSentBytes, photonTotalTimeMs, queuedOverloadTimeMs, queuedProvisioningTimeMs, readBytes, readCacheBytes, readFilesCount, readPartitionsCount, readRemoteBytes, resultFetchTimeMs, resultFromCache, rowsProducedCount, rowsReadCount, spillToDiskBytes, taskTotalTimeMs, totalFilesCount, totalPartitionsCount, totalTimeMs, writeRemoteBytes);
  }
  ...
  public String toString() {
    return new ToStringer(QueryMetrics.class)
      ...
      .add("writeRemoteBytes", writeRemoteBytes).toString();
  }
}
