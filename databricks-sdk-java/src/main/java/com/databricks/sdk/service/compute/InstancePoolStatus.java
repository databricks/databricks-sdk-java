...
public class InstancePoolStatus {
  ...
  public InstancePoolStatus setPendingInstanceErrors(Collection<PendingInstanceError> pendingInstanceErrors) {
  ...
  public String toString() {
    return new ToStringer(InstancePoolStatus.class)
      .add("pendingInstanceErrors", pendingInstanceErrors).toString();
  }
}
