...
class FileInfoPb {
  ...
  public FileInfoPb setCreatedAt(Long createdAt) {
  ...
  public FileInfoPb setDisplayName(String displayName) {
  ...
  public FileInfoPb setDownloadLink(String downloadLink) {
  ...
  public FileInfoPb setFileParent(FileParent fileParent) {
  ...
  public FileInfoPb setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public FileInfoPb setMarketplaceFileType(MarketplaceFileType marketplaceFileType) {
  ...
  public FileInfoPb setMimeType(String mimeType) {
  ...
  public FileInfoPb setStatus(FileStatus status) {
    this.status = status;
    return this;
  }
  ...
  public FileInfoPb setStatusMessage(String statusMessage) {
  ...
  public FileInfoPb setUpdatedAt(Long updatedAt) {
