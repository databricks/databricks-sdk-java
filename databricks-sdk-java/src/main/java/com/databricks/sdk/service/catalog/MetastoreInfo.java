...
@Generated
@JsonSerialize(using = MetastoreInfo.MetastoreInfoSerializer.class)
@JsonDeserialize(using = MetastoreInfo.MetastoreInfoDeserializer.class)
public class MetastoreInfo {
  ...
  MetastoreInfoPb toPb() {
    MetastoreInfoPb pb = new MetastoreInfoPb();
    pb.setCloud(cloud);
  ...
  static MetastoreInfo fromPb(MetastoreInfoPb pb) {
    MetastoreInfo model = new MetastoreInfo();
  ...
  public static class MetastoreInfoSerializer extends JsonSerializer<MetastoreInfo> {
    @Override
    public void serialize(MetastoreInfo value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      MetastoreInfoPb pb = value.toPb();
