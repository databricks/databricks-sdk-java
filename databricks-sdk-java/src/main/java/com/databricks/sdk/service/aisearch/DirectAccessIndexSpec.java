...
@Generated
public class DirectAccessIndexSpec {
   ...
   * timestamp}. Supported types for vector columns: {@code array<float>}, {@code array<double>}.
   */
  @JsonProperty("schema_json")
  private String schemaJson;

  public DirectAccessIndexSpec setEmbeddingSourceColumns(
  ...
  public DirectAccessIndexSpec setEmbeddingVectorColumns(
  ...
  public DirectAccessIndexSpec setSchemaJson(String schemaJson) {
  ...
  public boolean equals(Object o) {
    ...
    DirectAccessIndexSpec that = (DirectAccessIndexSpec) o;
  ...
  public String toString() {
    return new ToStringer(DirectAccessIndexSpec.class)
