...
public class GcpCommonNetworkConfig {
   ...
   * `PRIVATE_NODE_PUBLIC_MASTER` for a private GKE cluster for the workspace. The GKE nodes will
   * not have public IPs. Set to `PUBLIC_NODE_PUBLIC_MASTER` for a public GKE cluster. The nodes of
