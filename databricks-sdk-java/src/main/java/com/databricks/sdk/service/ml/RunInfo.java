...
public class RunInfo {
   ...
   * like `s3://bucket/directory` or `dbfs:/my/directory`. If not set, the local
  ...
  @Override
  public int hashCode() {
    return Objects.hash(artifactUri, endTime, experimentId, lifecycleStage, runId, runUuid, startTime, status, userId);
  }
