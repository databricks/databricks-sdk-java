...
@Generated
class ListIpAccessListResponsePb {
  @JsonProperty("ip_access_lists")
  private Collection<IpAccessListInfo> ipAccessLists;

  public ListIpAccessListResponsePb setIpAccessLists(Collection<IpAccessListInfo> ipAccessLists) {
  ...
  public boolean equals(Object o) {
    ...
    ListIpAccessListResponsePb that = (ListIpAccessListResponsePb) o;
  ...
  public String toString() {
    return new ToStringer(ListIpAccessListResponsePb.class)
