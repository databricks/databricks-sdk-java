...
class RepoInfoPb {
  ...
  public RepoInfoPb setBranch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public RepoInfoPb setHeadCommitId(String headCommitId) {
  ...
  public RepoInfoPb setId(Long id) {
    this.id = id;
    return this;
  }
  ...
  public RepoInfoPb setPath(String path) {
    this.path = path;
    return this;
  }
  ...
  public RepoInfoPb setProvider(String provider) {
  ...
  public RepoInfoPb setSparseCheckout(SparseCheckout sparseCheckout) {
  ...
  public RepoInfoPb setUrl(String url) {
    this.url = url;
    return this;
  }
  ...
  public String toString() {
    return new ToStringer(RepoInfoPb.class)
        .add("branch", branch)
