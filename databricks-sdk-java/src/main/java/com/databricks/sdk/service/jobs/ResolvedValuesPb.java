...
class ResolvedValuesPb {
  ...
  public ResolvedValuesPb setConditionTask(ResolvedConditionTaskValues conditionTask) {
  ...
  public ResolvedValuesPb setDbtTask(ResolvedDbtTaskValues dbtTask) {
  ...
  public ResolvedValuesPb setNotebookTask(ResolvedNotebookTaskValues notebookTask) {
  ...
  public ResolvedValuesPb setPythonWheelTask(ResolvedPythonWheelTaskValues pythonWheelTask) {
  ...
  public ResolvedValuesPb setRunJobTask(ResolvedRunJobTaskValues runJobTask) {
  ...
  public ResolvedValuesPb setSimulationTask(ResolvedParamPairValues simulationTask) {
  ...
  public ResolvedValuesPb setSparkJarTask(ResolvedStringParamsValues sparkJarTask) {
  ...
  public ResolvedValuesPb setSparkPythonTask(ResolvedStringParamsValues sparkPythonTask) {
  ...
  public ResolvedValuesPb setSparkSubmitTask(ResolvedStringParamsValues sparkSubmitTask) {
  ...
  public ResolvedValuesPb setSqlTask(ResolvedParamPairValues sqlTask) {
  ...
  public boolean equals(Object o) {
    ...
    ResolvedValuesPb that = (ResolvedValuesPb) o;
  ...
  public String toString() {
    return new ToStringer(ResolvedValuesPb.class)
