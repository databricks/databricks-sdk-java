...
class JobEmailNotificationsPb {
  ...
  public JobEmailNotificationsPb setNoAlertForSkippedRuns(Boolean noAlertForSkippedRuns) {
  ...
  public JobEmailNotificationsPb setOnDurationWarningThresholdExceeded(
  ...
  public JobEmailNotificationsPb setOnFailure(Collection<String> onFailure) {
  ...
  public JobEmailNotificationsPb setOnStart(Collection<String> onStart) {
  ...
  public JobEmailNotificationsPb setOnStreamingBacklogExceeded(
  ...
  public JobEmailNotificationsPb setOnSuccess(Collection<String> onSuccess) {
  ...
  public boolean equals(Object o) {
    ...
    JobEmailNotificationsPb that = (JobEmailNotificationsPb) o;
  ...
  public String toString() {
    return new ToStringer(JobEmailNotificationsPb.class)
