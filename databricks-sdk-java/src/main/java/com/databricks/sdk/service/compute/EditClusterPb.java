...
class EditClusterPb {
  ...
  public EditClusterPb setApplyPolicyDefaultValues(Boolean applyPolicyDefaultValues) {
  ...
  public EditClusterPb setAutoscale(AutoScale autoscale) {
  ...
  public EditClusterPb setAutoterminationMinutes(Long autoterminationMinutes) {
  ...
  public EditClusterPb setAwsAttributes(AwsAttributes awsAttributes) {
  ...
  public EditClusterPb setAzureAttributes(AzureAttributes azureAttributes) {
  ...
  public EditClusterPb setClusterId(String clusterId) {
  ...
  public EditClusterPb setClusterLogConf(ClusterLogConf clusterLogConf) {
  ...
  public EditClusterPb setClusterName(String clusterName) {
  ...
  public EditClusterPb setCustomTags(Map<String, String> customTags) {
  ...
  public EditClusterPb setDataSecurityMode(DataSecurityMode dataSecurityMode) {
  ...
  public EditClusterPb setDockerImage(DockerImage dockerImage) {
  ...
  public EditClusterPb setDriverInstancePoolId(String driverInstancePoolId) {
  ...
  public EditClusterPb setDriverNodeTypeId(String driverNodeTypeId) {
  ...
  public EditClusterPb setEnableElasticDisk(Boolean enableElasticDisk) {
  ...
  public EditClusterPb setEnableLocalDiskEncryption(Boolean enableLocalDiskEncryption) {
  ...
  public EditClusterPb setGcpAttributes(GcpAttributes gcpAttributes) {
  ...
  public EditClusterPb setInitScripts(Collection<InitScriptInfo> initScripts) {
  ...
  public EditClusterPb setInstancePoolId(String instancePoolId) {
  ...
  public EditClusterPb setIsSingleNode(Boolean isSingleNode) {
  ...
  public EditClusterPb setKind(Kind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public EditClusterPb setNodeTypeId(String nodeTypeId) {
  ...
  public EditClusterPb setNumWorkers(Long numWorkers) {
  ...
  public EditClusterPb setPolicyId(String policyId) {
  ...
  public EditClusterPb setSingleUserName(String singleUserName) {
  ...
  public EditClusterPb setSparkConf(Map<String, String> sparkConf) {
  ...
  public EditClusterPb setSparkEnvVars(Map<String, String> sparkEnvVars) {
  ...
  public EditClusterPb setSparkVersion(String sparkVersion) {
  ...
  public EditClusterPb setSshPublicKeys(Collection<String> sshPublicKeys) {
  ...
  public EditClusterPb setWorkloadType(WorkloadType workloadType) {
  ...
  public boolean equals(Object o) {
    ...
    EditClusterPb that = (EditClusterPb) o;
  ...
  public String toString() {
    return new ToStringer(EditClusterPb.class)
