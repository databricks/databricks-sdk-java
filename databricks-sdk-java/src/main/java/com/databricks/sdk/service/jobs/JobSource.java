...
public class JobSource {
   ...
   *
   * <ul>
   *   <li>{@code NOT_SYNCED}: The job is not yet synced with the remote job specification. Import
   *       the remote job specification from UI to make the job fully synced.
   *   <li>{@code DISCONNECTED}: The job is temporary disconnected from the remote job specification
   *       and is allowed for live edit. Import the remote job specification again from UI to make
