...
class GetQualityMonitorRequestPb {
  ...
  public GetQualityMonitorRequestPb setObjectId(String objectId) {
  ...
  public GetQualityMonitorRequestPb setObjectType(String objectType) {
  ...
  public String toString() {
    return new ToStringer(GetQualityMonitorRequestPb.class)
