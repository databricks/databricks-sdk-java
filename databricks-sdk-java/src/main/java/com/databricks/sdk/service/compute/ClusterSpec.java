...
public class ClusterSpec {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoscale, autoterminationMinutes, awsAttributes, azureAttributes, clusterLogConf, clusterName, clusterSource, customTags, dataSecurityMode, dockerImage, driverInstancePoolId, driverNodeTypeId, enableElasticDisk, enableLocalDiskEncryption, gcpAttributes, initScripts, instancePoolId, nodeTypeId, numWorkers, policyId, runtimeEngine, singleUserName, sparkConf, sparkEnvVars, sparkVersion, sshPublicKeys, workloadType);
  }
