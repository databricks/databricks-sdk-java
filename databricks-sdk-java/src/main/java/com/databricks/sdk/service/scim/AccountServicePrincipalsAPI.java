 ...
 */
public class AccountServicePrincipalsAPI implements AccountServicePrincipalsService {
    ...
    public ServicePrincipal create(ServicePrincipal request) {
        String path = String.format("/api/2.0/accounts//scim/v2/ServicePrincipals");
    ...
    public void delete(DeleteServicePrincipalRequest request) {
        String path = String.format("/api/2.0/accounts//scim/v2/ServicePrincipals/%s", request.getId());
