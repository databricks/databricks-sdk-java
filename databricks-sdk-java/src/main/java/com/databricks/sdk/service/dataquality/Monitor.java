...
public class Monitor {
  /** Anomaly Detection Configuration, applicable to {@code schema} object types. */
  @JsonProperty("anomaly_detection_config")
  private AnomalyDetectionConfig anomalyDetectionConfig;

  /**
   * Data Profiling Configuration, applicable to {@code table} object types. Exactly one {@code
