...
public class Policy {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAtTimestamp, creatorUserName, definition, description, isDefault, maxClustersPerUser, name, policyFamilyDefinitionOverrides, policyFamilyId, policyId);
  }
