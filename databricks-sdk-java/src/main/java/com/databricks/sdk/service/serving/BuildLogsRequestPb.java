...
@Generated
class BuildLogsRequestPb {
  @JsonIgnore private String name;

  @JsonIgnore private String servedModelName;

  public BuildLogsRequestPb setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public BuildLogsRequestPb setServedModelName(String servedModelName) {
  ...
  public boolean equals(Object o) {
    ...
    BuildLogsRequestPb that = (BuildLogsRequestPb) o;
  ...
  public String toString() {
    return new ToStringer(BuildLogsRequestPb.class)
        .add("name", name)
