...
@Generated
public class GetSupervisorAgentPermissionLevelsRequest {
  /** The supervisor agent for which to get or manage permissions. */
  @JsonIgnore private String supervisorAgentId;

  public GetSupervisorAgentPermissionLevelsRequest setSupervisorAgentId(String supervisorAgentId) {
  ...
  public boolean equals(Object o) {
    ...
    GetSupervisorAgentPermissionLevelsRequest that = (GetSupervisorAgentPermissionLevelsRequest) o;
  ...
  public String toString() {
    return new ToStringer(GetSupervisorAgentPermissionLevelsRequest.class)
