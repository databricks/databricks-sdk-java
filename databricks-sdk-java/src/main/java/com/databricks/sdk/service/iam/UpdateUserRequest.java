...
public class UpdateUserRequest {
  ...
  public UpdateUserRequest setEmails(Collection<ComplexValue> emails) {
    this.emails = emails;
    return this;
  }
  ...
  public UpdateUserRequest setEntitlements(Collection<ComplexValue> entitlements) {
  ...
  public UpdateUserRequest setGroups(Collection<ComplexValue> groups) {
    this.groups = groups;
    return this;
  }
  ...
  public UpdateUserRequest setRoles(Collection<ComplexValue> roles) {
    this.roles = roles;
    return this;
  }
  ...
  public UpdateUserRequest setSchemas(Collection<UserSchema> schemas) {
