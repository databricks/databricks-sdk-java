...
public class WarehouseAccessControlResponse {
  ...
  public WarehouseAccessControlResponse setDisplayName(String displayName) {
  ...
  public WarehouseAccessControlResponse setGroupName(String groupName) {
  ...
  public WarehouseAccessControlResponse setServicePrincipalName(String servicePrincipalName) {
  ...
  public WarehouseAccessControlResponse setUserName(String userName) {
  ...
  public boolean equals(Object o) {
    ...
    WarehouseAccessControlResponse that = (WarehouseAccessControlResponse) o;
  ...
  public String toString() {
    return new ToStringer(WarehouseAccessControlResponse.class)
