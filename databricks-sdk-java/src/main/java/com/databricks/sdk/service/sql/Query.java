...
public class Query {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(canEdit, createdAt, dataSourceId, description, id, isArchived, isDraft, isFavorite, isSafe, lastModifiedBy, lastModifiedById, latestQueryDataId, name, options, parent, permissionTier, query, queryHash, tags, updatedAt, user, userId, visualizations);
  }
  ...
  public String toString() {
    return new ToStringer(Query.class)
      ...
      .add("user", user)
      .add("userId", userId)
      .add("visualizations", visualizations).toString();
  }
}
