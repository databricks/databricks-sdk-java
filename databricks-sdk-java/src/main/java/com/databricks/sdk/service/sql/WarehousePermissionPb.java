...
class WarehousePermissionPb {
  ...
  public WarehousePermissionPb setInherited(Boolean inherited) {
  ...
  public WarehousePermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public WarehousePermissionPb setPermissionLevel(WarehousePermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    WarehousePermissionPb that = (WarehousePermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(WarehousePermissionPb.class)
