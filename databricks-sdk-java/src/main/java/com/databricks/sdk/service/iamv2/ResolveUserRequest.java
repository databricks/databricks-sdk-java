...
public class ResolveUserRequest {
  ...
  public ResolveUserRequest setExternalId(String externalId) {
  ...
  public boolean equals(Object o) {
    ...
    ResolveUserRequest that = (ResolveUserRequest) o;
  ...
  public String toString() {
    return new ToStringer(ResolveUserRequest.class).add("externalId", externalId).toString();
  }
}
