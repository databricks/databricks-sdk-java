...
public class BatchCreateAccessRequestsRequest {
   ...
   *
   * <p>At most 30 requests per API call.
   */
  @JsonProperty("requests")
  private Collection<CreateAccessRequest> requests;

  public BatchCreateAccessRequestsRequest setRequests(Collection<CreateAccessRequest> requests) {
    this.requests = requests;
    return this;
  }

  public Collection<CreateAccessRequest> getRequests() {
    return requests;
  }
