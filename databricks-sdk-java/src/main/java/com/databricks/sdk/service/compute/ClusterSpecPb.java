...
class ClusterSpecPb {
  ...
  public ClusterSpecPb setApplyPolicyDefaultValues(Boolean applyPolicyDefaultValues) {
  ...
  public ClusterSpecPb setAutoscale(AutoScale autoscale) {
  ...
  public ClusterSpecPb setAutoterminationMinutes(Long autoterminationMinutes) {
  ...
  public ClusterSpecPb setAwsAttributes(AwsAttributes awsAttributes) {
  ...
  public ClusterSpecPb setAzureAttributes(AzureAttributes azureAttributes) {
  ...
  public ClusterSpecPb setClusterLogConf(ClusterLogConf clusterLogConf) {
  ...
  public ClusterSpecPb setClusterName(String clusterName) {
  ...
  public ClusterSpecPb setCustomTags(Map<String, String> customTags) {
  ...
  public ClusterSpecPb setDataSecurityMode(DataSecurityMode dataSecurityMode) {
  ...
  public ClusterSpecPb setDockerImage(DockerImage dockerImage) {
  ...
  public ClusterSpecPb setDriverInstancePoolId(String driverInstancePoolId) {
  ...
  public ClusterSpecPb setDriverNodeTypeId(String driverNodeTypeId) {
  ...
  public ClusterSpecPb setEnableElasticDisk(Boolean enableElasticDisk) {
  ...
  public ClusterSpecPb setEnableLocalDiskEncryption(Boolean enableLocalDiskEncryption) {
  ...
  public ClusterSpecPb setGcpAttributes(GcpAttributes gcpAttributes) {
  ...
  public ClusterSpecPb setInitScripts(Collection<InitScriptInfo> initScripts) {
  ...
  public ClusterSpecPb setInstancePoolId(String instancePoolId) {
  ...
  public ClusterSpecPb setIsSingleNode(Boolean isSingleNode) {
  ...
  public ClusterSpecPb setKind(Kind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ClusterSpecPb setNodeTypeId(String nodeTypeId) {
  ...
  public ClusterSpecPb setNumWorkers(Long numWorkers) {
  ...
  public ClusterSpecPb setPolicyId(String policyId) {
  ...
  public ClusterSpecPb setRemoteDiskThroughput(Long remoteDiskThroughput) {
  ...
  public ClusterSpecPb setRuntimeEngine(RuntimeEngine runtimeEngine) {
  ...
  public ClusterSpecPb setSingleUserName(String singleUserName) {
  ...
  public ClusterSpecPb setSparkConf(Map<String, String> sparkConf) {
  ...
  public ClusterSpecPb setSparkEnvVars(Map<String, String> sparkEnvVars) {
  ...
  public ClusterSpecPb setSparkVersion(String sparkVersion) {
  ...
  public ClusterSpecPb setSshPublicKeys(Collection<String> sshPublicKeys) {
  ...
  public ClusterSpecPb setTotalInitialRemoteDiskSize(Long totalInitialRemoteDiskSize) {
  ...
  public ClusterSpecPb setUseMlRuntime(Boolean useMlRuntime) {
  ...
  public ClusterSpecPb setWorkloadType(WorkloadType workloadType) {
