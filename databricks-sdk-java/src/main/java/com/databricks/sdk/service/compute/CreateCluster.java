...
@Generated
@JsonSerialize(using = CreateCluster.CreateClusterSerializer.class)
@JsonDeserialize(using = CreateCluster.CreateClusterDeserializer.class)
public class CreateCluster {
  ...
  public CreateCluster setRemoteDiskThroughput(Long remoteDiskThroughput) {
  ...
  public CreateCluster setTotalInitialRemoteDiskSize(Long totalInitialRemoteDiskSize) {
  ...
  CreateClusterPb toPb() {
    CreateClusterPb pb = new CreateClusterPb();
  ...
  static CreateCluster fromPb(CreateClusterPb pb) {
    CreateCluster model = new CreateCluster();
    ...
    model.setCloneFrom(pb.getCloneFrom());
  ...
  public static class CreateClusterSerializer extends JsonSerializer<CreateCluster> {
    @Override
    public void serialize(CreateCluster value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      CreateClusterPb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class CreateClusterDeserializer extends JsonDeserializer<CreateCluster> {
    @Override
    public CreateCluster deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      CreateClusterPb pb = mapper.readValue(p, CreateClusterPb.class);
      return CreateCluster.fromPb(pb);
    }
  }
}
