...
public class CreateCluster {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applyPolicyDefaultValues, autoscale, autoterminationMinutes, awsAttributes, azureAttributes, clusterLogConf, clusterName, clusterSource, customTags, driverInstancePoolId, driverNodeTypeId, enableElasticDisk, enableLocalDiskEncryption, gcpAttributes, initScripts, instancePoolId, nodeTypeId, numWorkers, policyId, runtimeEngine, sparkConf, sparkEnvVars, sparkVersion, sshPublicKeys, workloadType);
  }
