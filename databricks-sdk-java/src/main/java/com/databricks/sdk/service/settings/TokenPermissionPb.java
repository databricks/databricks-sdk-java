...
class TokenPermissionPb {
  ...
  public TokenPermissionPb setInherited(Boolean inherited) {
  ...
  public TokenPermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public TokenPermissionPb setPermissionLevel(TokenPermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    TokenPermissionPb that = (TokenPermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(TokenPermissionPb.class)
