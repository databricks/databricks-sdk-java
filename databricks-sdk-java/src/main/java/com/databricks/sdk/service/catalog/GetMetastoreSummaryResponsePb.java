...
@Generated
class GetMetastoreSummaryResponsePb {
  @JsonProperty("cloud")
  ...
  public GetMetastoreSummaryResponsePb setCloud(String cloud) {
    this.cloud = cloud;
    return this;
  }
  ...
  public GetMetastoreSummaryResponsePb setCreatedAt(Long createdAt) {
  ...
  public GetMetastoreSummaryResponsePb setCreatedBy(String createdBy) {
  ...
  public GetMetastoreSummaryResponsePb setDeltaSharingOrganizationName(
  ...
  public GetMetastoreSummaryResponsePb setDeltaSharingRecipientTokenLifetimeInSeconds(
  ...
  public GetMetastoreSummaryResponsePb setDeltaSharingScope(
      DeltaSharingScopeEnum deltaSharingScope) {
  ...
  public GetMetastoreSummaryResponsePb setExternalAccessEnabled(Boolean externalAccessEnabled) {
  ...
  public GetMetastoreSummaryResponsePb setGlobalMetastoreId(String globalMetastoreId) {
  ...
  public GetMetastoreSummaryResponsePb setMetastoreId(String metastoreId) {
  ...
  public GetMetastoreSummaryResponsePb setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetMetastoreSummaryResponsePb setOwner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GetMetastoreSummaryResponsePb setPrivilegeModelVersion(String privilegeModelVersion) {
  ...
  public GetMetastoreSummaryResponsePb setStorageRoot(String storageRoot) {
  ...
  public GetMetastoreSummaryResponsePb setStorageRootCredentialId(String storageRootCredentialId) {
  ...
  public GetMetastoreSummaryResponsePb setStorageRootCredentialName(
  ...
  public GetMetastoreSummaryResponsePb setUpdatedAt(Long updatedAt) {
  ...
  public GetMetastoreSummaryResponsePb setUpdatedBy(String updatedBy) {
  ...
  public boolean equals(Object o) {
    ...
    GetMetastoreSummaryResponsePb that = (GetMetastoreSummaryResponsePb) o;
  ...
  public String toString() {
    return new ToStringer(GetMetastoreSummaryResponsePb.class)
        .add("cloud", cloud)
