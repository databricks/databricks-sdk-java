 ...
 * link shared by the data provider to download the credential file that includes the access token.
 * The recipient will then use the credential file to establish a secure connection with the
