...
public class ListJobComplianceForPolicyResponse {
  ...
  @JsonProperty("jobs")
  private Collection<ListJobComplianceForPolicyJobCompliance> jobs;
  ...
  public ListJobComplianceForPolicyResponse setJobs(
      Collection<ListJobComplianceForPolicyJobCompliance> jobs) {
    this.jobs = jobs;
    return this;
  }

  public Collection<ListJobComplianceForPolicyJobCompliance> getJobs() {
    return jobs;
  }
