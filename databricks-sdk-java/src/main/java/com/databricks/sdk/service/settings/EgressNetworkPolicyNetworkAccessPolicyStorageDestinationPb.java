...
@Generated
class EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb {
  ...
  public EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb setAzureStorageAccount(
  ...
  public EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb setAzureStorageService(
  ...
  public EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb setBucketName(
      String bucketName) {
  ...
  public EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb setRegion(String region) {
    this.region = region;
    return this;
  }
  ...
  public EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb setStorageDestinationType(
  ...
  public boolean equals(Object o) {
    ...
    EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb that =
        (EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb) o;
  ...
  public String toString() {
    return new ToStringer(EgressNetworkPolicyNetworkAccessPolicyStorageDestinationPb.class)
