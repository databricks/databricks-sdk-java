...
class ExperimentPermissionPb {
  ...
  public ExperimentPermissionPb setInherited(Boolean inherited) {
  ...
  public ExperimentPermissionPb setInheritedFromObject(Collection<String> inheritedFromObject) {
  ...
  public ExperimentPermissionPb setPermissionLevel(ExperimentPermissionLevel permissionLevel) {
  ...
  public boolean equals(Object o) {
    ...
    ExperimentPermissionPb that = (ExperimentPermissionPb) o;
  ...
  public String toString() {
    return new ToStringer(ExperimentPermissionPb.class)
