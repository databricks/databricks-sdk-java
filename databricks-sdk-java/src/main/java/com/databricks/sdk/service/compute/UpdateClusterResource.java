...
@Generated
@JsonSerialize(using = UpdateClusterResource.UpdateClusterResourceSerializer.class)
@JsonDeserialize(using = UpdateClusterResource.UpdateClusterResourceDeserializer.class)
public class UpdateClusterResource {
  /**
  ...
  public UpdateClusterResource setRemoteDiskThroughput(Long remoteDiskThroughput) {
  ...
  public UpdateClusterResource setTotalInitialRemoteDiskSize(Long totalInitialRemoteDiskSize) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateClusterResource that = (UpdateClusterResource) o;
  ...
  public String toString() {
    return new ToStringer(UpdateClusterResource.class)
  ...
  UpdateClusterResourcePb toPb() {
    UpdateClusterResourcePb pb = new UpdateClusterResourcePb();
  ...
  static UpdateClusterResource fromPb(UpdateClusterResourcePb pb) {
    UpdateClusterResource model = new UpdateClusterResource();
  ...
  public static class UpdateClusterResourceSerializer
      extends JsonSerializer<UpdateClusterResource> {
    @Override
    public void serialize(
        UpdateClusterResource value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
      UpdateClusterResourcePb pb = value.toPb();
      provider.defaultSerializeValue(pb, gen);
    }
  }

  public static class UpdateClusterResourceDeserializer
      extends JsonDeserializer<UpdateClusterResource> {
    @Override
    public UpdateClusterResource deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException {
      ObjectMapper mapper = (ObjectMapper) p.getCodec();
      UpdateClusterResourcePb pb = mapper.readValue(p, UpdateClusterResourcePb.class);
      return UpdateClusterResource.fromPb(pb);
    }
  }
}
