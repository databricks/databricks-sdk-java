...
class PutAiGatewayResponsePb {
  ...
  public PutAiGatewayResponsePb setFallbackConfig(FallbackConfig fallbackConfig) {
  ...
  public PutAiGatewayResponsePb setGuardrails(AiGatewayGuardrails guardrails) {
  ...
  public PutAiGatewayResponsePb setInferenceTableConfig(
  ...
  public PutAiGatewayResponsePb setRateLimits(Collection<AiGatewayRateLimit> rateLimits) {
  ...
  public PutAiGatewayResponsePb setUsageTrackingConfig(
  ...
  public boolean equals(Object o) {
    ...
    PutAiGatewayResponsePb that = (PutAiGatewayResponsePb) o;
  ...
  public String toString() {
    return new ToStringer(PutAiGatewayResponsePb.class)
