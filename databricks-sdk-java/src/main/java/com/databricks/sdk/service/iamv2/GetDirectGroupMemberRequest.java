...
@Generated
public class GetDirectGroupMemberRequest {
  ...
  public GetDirectGroupMemberRequest setGroupId(Long groupId) {
  ...
  public GetDirectGroupMemberRequest setPrincipalId(Long principalId) {
  ...
  public boolean equals(Object o) {
    ...
    GetDirectGroupMemberRequest that = (GetDirectGroupMemberRequest) o;
  ...
  public String toString() {
    return new ToStringer(GetDirectGroupMemberRequest.class)
        .add("groupId", groupId)
