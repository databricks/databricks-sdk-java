...
public class WorkspaceClient {
   ...
   *
   * <p>* **[Job permissions](jobs)** — Manage which users can view, manage, trigger, cancel, or own
   * a job.
   *
   ...
   * enabled.
   *
   * <p>* **[Instance Pool permissions](instancepools)** — Manage which users can manage or attach
   * to pools.
   *
