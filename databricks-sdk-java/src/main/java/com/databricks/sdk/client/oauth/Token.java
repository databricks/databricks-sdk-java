...
public class Token {
    ...
    public static Token retrieveToken(String clientId,
                                      String clientSecret,
                                      String tokenUrl,
        ...
        try {
            StringEntity stringEntity = new StringEntity(objectMapper.writeValueAsString(params), ContentType.APPLICATION_JSON);
