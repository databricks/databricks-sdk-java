...
public class GithubUtils {
    ...
    // in the GitHub workflows to explicitly set executable permission on the source az file. Hence, we need
    // to set it inside the test so that this script is found inside the $PATH environment variable. This
