...
### API Changes
* Add `createDirectGroupMember()`, `createGroup()`, `createServicePrincipal()`, `createUser()`, `createWorkspaceAssignment()`, `deleteDirectGroupMember()`, `deleteGroup()`, `deleteServicePrincipal()`, `deleteUser()`, `deleteWorkspaceAssignment()`, `getDirectGroupMember()`, `getGroup()`, `getServicePrincipal()`, `getUser()`, `getWorkspaceAssignment()`, `listDirectGroupMembers()`, `listGroups()`, `listServicePrincipals()`, `listTransitiveParentGroups()`, `listUsers()`, `listWorkspaceAssignments()`, `updateGroup()`, `updateServicePrincipal()`, `updateUser()` and `updateWorkspaceAssignment()` methods for `accountClient.accountIamV2()` service.
* Add `createDirectGroupMemberProxy()`, `createGroupProxy()`, `createServicePrincipalProxy()`, `createUserProxy()`, `createWorkspaceAssignmentProxy()`, `deleteDirectGroupMemberProxy()`, `deleteGroupProxy()`, `deleteServicePrincipalProxy()`, `deleteUserProxy()`, `deleteWorkspaceAssignmentProxy()`, `getDirectGroupMemberProxy()`, `getGroupProxy()`, `getServicePrincipalProxy()`, `getUserProxy()`, `getWorkspaceAssignmentProxy()`, `getWorkspaceIdentityDetail()`, `listDirectGroupMembersProxy()`, `listGroupsProxy()`, `listServicePrincipalsProxy()`, `listTransitiveParentGroupsProxy()`, `listUsersProxy()`, `listWorkspaceAssignmentsProxy()`, `updateGroupProxy()`, `updateServicePrincipalProxy()`, `updateUserProxy()`, `updateWorkspaceAssignmentProxy()` and `updateWorkspaceIdentityDetail()` methods for `workspaceClient.workspaceIamV2()` service.
* Add `createTime` and `updateTime` fields for `com.databricks.sdk.service.dashboards.GenieSpace`.
* Change `newCluster` field for `com.databricks.sdk.service.jobs.JobCluster` to no longer be required.
* [Breaking] Change `newCluster` field for `com.databricks.sdk.service.jobs.JobCluster` to no longer be required.


## Release v0.145.0 (2026-08-12)

### API Changes
* Add `mlflowArtifactLocation` field for `com.databricks.sdk.service.jobs.AiRuntimeTask`.
* Add `triggerDetails` field for `com.databricks.sdk.service.jobs.BaseJob`.
* Add `triggers` field for `com.databricks.sdk.service.jobs.CreateJob`.
* Add `triggerDetails` field for `com.databricks.sdk.service.jobs.Job`.
* Add `triggers` field for `com.databricks.sdk.service.jobs.JobSettings`.
* Add `apiSourceConnectorOptions` field for `com.databricks.sdk.service.pipelines.ConnectorOptions`.
* Add `apiSourceConnectorConfig` field for `com.databricks.sdk.service.pipelines.SourceConfig`.
* Add `allVpcScServices` and `googleApiEndpoints` fields for `com.databricks.sdk.service.settings.GcpEndpoint`.


## Release v0.144.0 (2026-08-11)
...
## Release v0.143.0 (2026-08-06)

### API Changes
* Add `inputColumn` and `outputColumn` fields for `com.databricks.sdk.service.pipelines.Transformer`.
* Add `NETSUITE` enum value for `com.databricks.sdk.service.catalog.ConnectionType`.
* [Breaking] Remove `includeBrowse` field for `com.databricks.sdk.service.catalog.GetMcpServiceRequest`.
* [Breaking] Remove `includeBrowse` field for `com.databricks.sdk.service.catalog.GetModelProviderServiceRequest`.
* [Breaking] Remove `includeBrowse` field for `com.databricks.sdk.service.catalog.GetModelServiceRequest`.
* [Breaking] Remove `includeBrowse` field for `com.databricks.sdk.service.catalog.ListMcpServicesRequest`.
* [Breaking] Remove `includeBrowse` field for `com.databricks.sdk.service.catalog.ListModelProviderServicesRequest`.
* [Breaking] Remove `includeBrowse` field for `com.databricks.sdk.service.catalog.ListModelServicesRequest`.
* [Breaking] Remove `browseOnly` field for `com.databricks.sdk.service.catalog.McpService`.
* [Breaking] Remove `browseOnly` field for `com.databricks.sdk.service.catalog.ModelProviderService`.
* [Breaking] Remove `browseOnly` field for `com.databricks.sdk.service.catalog.ModelService`.


## Release v0.142.0 (2026-08-05)
...
### API Changes
* Add `workspaceClient.aiGateway()` service.
* Add `updateOperation()` method for `workspaceClient.bundleDeployments()` service.
* Add `lastSuccessfulVersionId` and `updatedBy` fields for `com.databricks.sdk.service.bundledeployments.Deployment`.
* Add `dashboardMetadata`, `sequenceId` and `updateTime` fields for `com.databricks.sdk.service.bundledeployments.Operation`.
* Add `dashboardMetadata` field for `com.databricks.sdk.service.bundledeployments.Resource`.
* Add `previousVersionId` field for `com.databricks.sdk.service.bundledeployments.Version`.


## Release v0.136.0 (2026-07-28)
...
### API Changes
* Add `dependencyMode` field for `com.databricks.sdk.service.compute.ClusterAttributes`.
* Add `dependencyMode` field for `com.databricks.sdk.service.compute.ClusterDetails`.
* Add `dependencyMode` field for `com.databricks.sdk.service.compute.ClusterSpec`.
* Add `dependencyMode` field for `com.databricks.sdk.service.compute.CreateCluster`.
* Add `dependencyMode` field for `com.databricks.sdk.service.compute.EditCluster`.
* Add `dependencyMode` field for `com.databricks.sdk.service.compute.EnforcePolicyComplianceForClusterResponseClusterSettings`.
* Add `dependencyMode` field for `com.databricks.sdk.service.compute.UpdateClusterResource`.
* Add `codeSourcePath` field for `com.databricks.sdk.service.jobs.AiRuntimeTask`.
* Add `schemaRegistryConfig` field for `com.databricks.sdk.service.ml.StreamSchemaConfig`.
* Add `extraColumns` field for `com.databricks.sdk.service.postgres.SyncedTableSyncedTableSpec`.
* [Breaking] Remove `lifetime` field for `com.databricks.sdk.service.ml.TimeWindow`.


## Release v0.133.0 (2026-07-22)
...
## Release v0.129.0 (2026-07-14)

### API Changes
* Add `enableSharedOutput` field for `com.databricks.sdk.service.cleanrooms.CleanRoom`.
* Add `description` and `environmentVersion` fields for `com.databricks.sdk.service.cleanrooms.CleanRoomAssetNotebook`.
* Add `sharedOutputSchemaExpirationTime` and `sharedOutputSchemaName` fields for `com.databricks.sdk.service.cleanrooms.CleanRoomNotebookTaskRun`.
* Add `enableSharedOutput` and `packageProviderCollaboratorAlias` fields for `com.databricks.sdk.service.cleanrooms.CleanRoomRemoteDetail`.
* Add `customReportOptions` field for `com.databricks.sdk.service.pipelines.GoogleAdsOptions`.
* Add `customReportOptions` field for `com.databricks.sdk.service.pipelines.MetaMarketingOptions`.
* Add `customReportOptions` field for `com.databricks.sdk.service.pipelines.TikTokAdsOptions`.
...
* Add `filters` field for `com.databricks.sdk.service.jobs.DashboardTask`.
* Add `SSWS_TOKEN` enum value for `com.databricks.sdk.service.catalog.CredentialType`.
